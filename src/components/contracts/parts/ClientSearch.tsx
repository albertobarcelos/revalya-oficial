...
import { Search, Plus, Users, Building2, Mail, Phone, FileText, Loader2, ChevronLeft, ChevronRight, X } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={handleClose} modal>
      <BillingDialogContent className="p-0 m-0 border-0">
        ...
        <DialogPrimitive.Description className="sr-only">
          Modal para buscar e selecionar um cliente para o faturamento avulso
        ...
        <div className="flex flex-col h-full min-h-0 overflow-hidden p-6">
          {/* AIDEV-NOTE: Cabeçalho com título e botão de fechar */}
