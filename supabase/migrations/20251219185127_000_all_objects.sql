  ...
  create table "public"."payment_gateways" (
    ...
    "api_key" text,
    "api_secret" text,
    "environment" character varying(20) not null default 'homologacao'::character varying,
...
alter table "public"."bank_operation_history" alter column "amount" set data type numeric(18,2) using "amount"::numeric(18,2);

alter table "public"."bank_operation_history" enable row level security;

alter table "public"."billing_period_items" alter column "quantity" set data type numeric(15,6) using "quantity"::numeric(15,6);

alter table "public"."billing_period_items" alter column "total_price" set data type numeric(15,2) using "total_price"::numeric(15,2);

alter table "public"."billing_period_items" alter column "unit_price" set data type numeric(15,2) using "unit_price"::numeric(15,2);

alter table "public"."charges" alter column "asaas_discount_value" set data type numeric(10,2) using "asaas_discount_value"::numeric(10,2);

alter table "public"."charges" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."charges" alter column "installment_value" set data type numeric(10,2) using "installment_value"::numeric(10,2);

alter table "public"."charges" alter column "valor" set data type numeric(10,2) using "valor"::numeric(10,2);

alter table "public"."charges" enable row level security;

alter table "public"."conciliation_history" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."conciliation_history" enable row level security;

alter table "public"."conciliation_rules" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."conciliation_rules" enable row level security;

alter table "public"."conciliation_staging" alter column "taxa_juros" set data type numeric(10,2) using "taxa_juros"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "taxa_multa" set data type numeric(10,2) using "taxa_multa"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "valor_cobranca" set data type numeric(10,2) using "valor_cobranca"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "valor_desconto" set data type numeric(10,2) using "valor_desconto"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "valor_liquido" set data type numeric(10,2) using "valor_liquido"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "valor_original" set data type numeric(10,2) using "valor_original"::numeric(10,2);

alter table "public"."conciliation_staging" alter column "valor_pago" set data type numeric(10,2) using "valor_pago"::numeric(10,2);

alter table "public"."contract_attachments" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_billing_items" alter column "discount_amount" set data type numeric(10,2) using "discount_amount"::numeric(10,2);

alter table "public"."contract_billing_items" alter column "discount_percentage" set data type numeric(10,6) using "discount_percentage"::numeric(10,6);

alter table "public"."contract_billing_items" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_billing_items" alter column "quantity" set data type numeric(10,4) using "quantity"::numeric(10,4);

alter table "public"."contract_billing_items" alter column "tax_amount" set data type numeric(10,2) using "tax_amount"::numeric(10,2);

alter table "public"."contract_billing_items" alter column "tax_rate" set data type numeric(5,2) using "tax_rate"::numeric(5,2);

alter table "public"."contract_billing_items" alter column "total_amount" set data type numeric(10,2) using "total_amount"::numeric(10,2);

alter table "public"."contract_billing_items" alter column "unit_price" set data type numeric(10,2) using "unit_price"::numeric(10,2);

alter table "public"."contract_billing_items" enable row level security;

alter table "public"."contract_billing_payments" alter column "amount" set data type numeric(10,2) using "amount"::numeric(10,2);

alter table "public"."contract_billing_payments" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_billing_payments" enable row level security;

alter table "public"."contract_billing_periods" alter column "amount_billed" set data type numeric(10,2) using "amount_billed"::numeric(10,2);

alter table "public"."contract_billing_periods" alter column "amount_planned" set data type numeric(10,2) using "amount_planned"::numeric(10,2);

alter table "public"."contract_billing_periods" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_billing_periods" enable row level security;

alter table "public"."contract_billings" alter column "amount" set data type numeric(10,2) using "amount"::numeric(10,2);

alter table "public"."contract_billings" alter column "complementary_amount" set data type numeric(10,2) using "complementary_amount"::numeric(10,2);

alter table "public"."contract_billings" alter column "discount_amount" set data type numeric(10,2) using "discount_amount"::numeric(10,2);

alter table "public"."contract_billings" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_billings" alter column "net_amount" set data type numeric(10,2) using "net_amount"::numeric(10,2);

alter table "public"."contract_billings" alter column "original_amount" set data type numeric(10,2) using "original_amount"::numeric(10,2);

alter table "public"."contract_billings" alter column "tax_amount" set data type numeric(10,2) using "tax_amount"::numeric(10,2);

alter table "public"."contract_billings" enable row level security;

alter table "public"."contract_products" alter column "discount_amount" set data type numeric(10,2) using "discount_amount"::numeric(10,2);

alter table "public"."contract_products" alter column "discount_percentage" set data type numeric(10,6) using "discount_percentage"::numeric(10,6);

alter table "public"."contract_products" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_products" alter column "quantity" set data type numeric(10,4) using "quantity"::numeric(10,4);

alter table "public"."contract_products" alter column "tax_amount" set data type numeric(10,2) using "tax_amount"::numeric(10,2);

alter table "public"."contract_products" alter column "tax_rate" set data type numeric(5,2) using "tax_rate"::numeric(5,2);

alter table "public"."contract_products" alter column "total_amount" set data type numeric(10,2) using "total_amount"::numeric(10,2);

alter table "public"."contract_products" alter column "unit_price" set data type numeric(10,2) using "unit_price"::numeric(10,2);

alter table "public"."contract_services" alter column "cost_price" set data type numeric(10,2) using "cost_price"::numeric(10,2);

alter table "public"."contract_services" alter column "discount_amount" set data type numeric(10,2) using "discount_amount"::numeric(10,2);

alter table "public"."contract_services" alter column "discount_percentage" set data type numeric(10,6) using "discount_percentage"::numeric(10,6);

alter table "public"."contract_services" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_services" alter column "quantity" set data type numeric(10,4) using "quantity"::numeric(10,4);

alter table "public"."contract_services" alter column "tax_amount" set data type numeric(10,2) using "tax_amount"::numeric(10,2);

alter table "public"."contract_services" alter column "tax_rate" set data type numeric(5,2) using "tax_rate"::numeric(5,2);

alter table "public"."contract_services" alter column "total_amount" set data type numeric(10,2) using "total_amount"::numeric(10,2);

alter table "public"."contract_services" alter column "unit_price" set data type numeric(10,2) using "unit_price"::numeric(10,2);

alter table "public"."contract_stage_history" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_stage_history" enable row level security;

alter table "public"."contract_stage_transitions" alter column "allowed_roles" set data type character varying(50)[] using "allowed_roles"::character varying(50)[];

alter table "public"."contract_stage_transitions" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."contract_stage_transitions" enable row level security;

alter table "public"."contract_stages" alter column "id" set default extensions.uuid_generate_v4();
...
alter table "public"."contracts" alter column "total_amount" set data type numeric(10,2) using "total_amount"::numeric(10,2);

alter table "public"."contracts" alter column "total_discount" set data type numeric(10,2) using "total_discount"::numeric(10,2);

alter table "public"."contracts" alter column "total_tax" set data type numeric(10,2) using "total_tax"::numeric(10,2);
...
-- NOTA: As colunas customer_id e notes EXISTEM na produção e devem ser mantidas
-- O diff está gerando DROP incorretamente porque o shadow database não está aplicando corretamente
-- o bloco DO $$ da migration principal. Essas colunas devem ser mantidas.
-- alter table "public"."finance_entries" drop column "customer_id";
-- alter table "public"."finance_entries" drop column "notes";

alter table "public"."finance_entries" add column "invoice_data" jsonb default '{}'::jsonb;

alter table "public"."finance_entries" add column "invoice_status" character varying(20);

alter table "public"."finance_entries" alter column "amount" set data type numeric(12,2) using "amount"::numeric(12,2);

alter table "public"."finance_entries" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."financial_payables" alter column "gross_amount" set data type numeric(14,2) using "gross_amount"::numeric(14,2);

alter table "public"."financial_payables" alter column "net_amount" set data type numeric(14,2) using "net_amount"::numeric(14,2);

alter table "public"."financial_payables" alter column "paid_amount" set data type numeric(14,2) using "paid_amount"::numeric(14,2);

alter table "public"."health_check" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."health_check" enable row level security;

alter table "public"."message_history" alter column "batch_id" set default extensions.uuid_generate_v4();

alter table "public"."message_history" alter column "id" set default extensions.uuid_generate_v4();
...
alter table "public"."product_stock_by_location" alter column "available_stock" set data type numeric(15,6) using "available_stock"::numeric(15,6);

alter table "public"."product_stock_by_location" alter column "min_stock" set data type numeric(15,6) using "min_stock"::numeric(15,6);

alter table "public"."product_stock_by_location" alter column "total_cmc" set data type numeric(15,2) using "total_cmc"::numeric(15,2);

alter table "public"."product_stock_by_location" alter column "unit_cmc" set data type numeric(15,2) using "unit_cmc"::numeric(15,2);

alter table "public"."products" alter column "cost_price" set data type numeric(15,2) using "cost_price"::numeric(15,2);

alter table "public"."products" alter column "tax_rate" set data type numeric(5,2) using "tax_rate"::numeric(5,2);

alter table "public"."products" alter column "unit_price" set data type numeric(15,2) using "unit_price"::numeric(15,2);

alter table "public"."profiles" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."profiles" enable row level security;

alter table "public"."receipts" alter column "desconto" set data type numeric(10,2) using "desconto"::numeric(10,2);

alter table "public"."receipts" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."receipts" alter column "juros" set data type numeric(10,2) using "juros"::numeric(10,2);

alter table "public"."receipts" alter column "multa" set data type numeric(10,2) using "multa"::numeric(10,2);

alter table "public"."receipts" alter column "valor_original" set data type numeric(10,2) using "valor_original"::numeric(10,2);

alter table "public"."receipts" alter column "valor_recebido" set data type numeric(10,2) using "valor_recebido"::numeric(10,2);

alter table "public"."receipts" enable row level security;

alter table "public"."regua_cobranca_config" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_config" enable row level security;

alter table "public"."regua_cobranca_estatisticas" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_etapas" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_etapas" enable row level security;

alter table "public"."regua_cobranca_execucao" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_interacoes" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_mensagens" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_template_etapas" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."regua_cobranca_templates" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."resellers" alter column "commission_rate" set data type numeric(5,2) using "commission_rate"::numeric(5,2);

alter table "public"."resellers" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."resellers" enable row level security;

alter table "public"."resellers_users" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."resellers_users" enable row level security;

alter table "public"."service_billing_events" alter column "amount" set data type numeric(15,2) using "amount"::numeric(15,2);

alter table "public"."service_billing_events" enable row level security;

alter table "public"."services" alter column "default_price" set data type numeric(10,2) using "default_price"::numeric(10,2);

alter table "public"."services" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."services" alter column "tax_rate" set data type numeric(5,2) using "tax_rate"::numeric(5,2);

alter table "public"."stock_movements" alter column "accumulated_balance" set data type numeric(15,6) using "accumulated_balance"::numeric(15,6);

alter table "public"."stock_movements" alter column "quantity" set data type numeric(15,6) using "quantity"::numeric(15,6);

alter table "public"."stock_movements" alter column "total_cmc" set data type numeric(15,2) using "total_cmc"::numeric(15,2);

alter table "public"."stock_movements" alter column "total_value" set data type numeric(15,2) using "total_value"::numeric(15,2);

alter table "public"."stock_movements" alter column "unit_cmc" set data type numeric(15,2) using "unit_cmc"::numeric(15,2);

alter table "public"."stock_movements" alter column "unit_value" set data type numeric(15,2) using "unit_value"::numeric(15,2);

alter table "public"."tenant_access_codes" enable row level security;

alter table "public"."tenant_invites" alter column "id" set default extensions.uuid_generate_v4();

alter table "public"."tenant_users" alter column "id" set default extensions.uuid_generate_v4();
...
CREATE UNIQUE INDEX agente_ia_empresa_pkey ON public.agente_ia_empresa USING btree (id);

CREATE UNIQUE INDEX agente_ia_mensagens_regua_pkey ON public.agente_ia_mensagens_regua USING btree (id);

CREATE UNIQUE INDEX audit_logs_pkey ON public.audit_logs USING btree (id);

CREATE UNIQUE INDEX bank_acounts_pkey ON public.bank_acounts USING btree (id);
...
CREATE UNIQUE INDEX bank_operation_history_pkey ON public.bank_operation_history USING btree (id);

CREATE UNIQUE INDEX billing_period_items_pkey ON public.billing_period_items USING btree (id);

CREATE UNIQUE INDEX charges_pkey ON public.charges USING btree (id);

CREATE UNIQUE INDEX charges_tenant_asaas_id_unique ON public.charges USING btree (tenant_id, asaas_id);
...
CREATE UNIQUE INDEX conciliation_history_pkey ON public.conciliation_history USING btree (id);

CREATE UNIQUE INDEX conciliation_rules_pkey ON public.conciliation_rules USING btree (id);

CREATE UNIQUE INDEX conciliation_staging_id_externo_unique ON public.conciliation_staging USING btree (id_externo);

CREATE UNIQUE INDEX conciliation_staging_pkey ON public.conciliation_staging USING btree (id);

CREATE UNIQUE INDEX conciliation_staging_tenant_id_origem_id_externo_key ON public.conciliation_staging USING btree (tenant_id, origem, id_externo);

CREATE UNIQUE INDEX contract_attachments_pkey ON public.contract_attachments USING btree (id);

CREATE UNIQUE INDEX contract_billing_items_pkey ON public.contract_billing_items USING btree (id);

CREATE UNIQUE INDEX contract_billing_payments_pkey ON public.contract_billing_payments USING btree (id);

CREATE UNIQUE INDEX contract_billing_periods_pkey ON public.contract_billing_periods USING btree (id);

CREATE UNIQUE INDEX contract_billings_pkey ON public.contract_billings USING btree (id);

CREATE UNIQUE INDEX contract_billings_tenant_id_billing_number_key ON public.contract_billings USING btree (tenant_id, billing_number);

CREATE UNIQUE INDEX contract_products_contract_id_product_id_key ON public.contract_products USING btree (contract_id, product_id);

CREATE UNIQUE INDEX contract_products_pkey ON public.contract_products USING btree (id);
...
CREATE UNIQUE INDEX contract_stage_history_pkey ON public.contract_stage_history USING btree (id);

CREATE UNIQUE INDEX contract_stage_transition_rules_pkey ON public.contract_stage_transition_rules USING btree (id);

CREATE UNIQUE INDEX contract_stage_transitions_pkey ON public.contract_stage_transitions USING btree (id);

CREATE UNIQUE INDEX contract_stage_transitions_tenant_id_from_stage_id_to_stage_key ON public.contract_stage_transitions USING btree (tenant_id, from_stage_id, to_stage_id);

CREATE UNIQUE INDEX contract_stages_pkey ON public.contract_stages USING btree (id);

CREATE UNIQUE INDEX contract_stages_tenant_id_code_key ON public.contract_stages USING btree (tenant_id, code);

CREATE UNIQUE INDEX contracts_pkey ON public.contracts USING btree (id);

CREATE UNIQUE INDEX contracts_tenant_id_number_key ON public.contracts USING btree (tenant_id, contract_number);

CREATE UNIQUE INDEX customers_asaas_id_cpf_cnpj_key ON public.customers USING btree (customer_asaas_id, cpf_cnpj);

CREATE UNIQUE INDEX customers_pkey ON public.customers USING btree (id);

CREATE UNIQUE INDEX des_payables_sequence_pkey ON public.des_payables_sequence USING btree (tenant_id);

CREATE UNIQUE INDEX finance_entries_pkey ON public.finance_entries USING btree (id);

CREATE INDEX financial_documents_list_idx ON public.financial_documents USING btree (tenant_id, is_active);

CREATE UNIQUE INDEX financial_documents_pkey ON public.financial_documents USING btree (id);

CREATE UNIQUE INDEX financial_documents_unique_name ON public.financial_documents USING btree (tenant_id, lower(name));

CREATE UNIQUE INDEX financial_launchs_pkey ON public.financial_launchs USING btree (id);
...
CREATE UNIQUE INDEX financial_payables_pkey ON public.financial_payables USING btree (id);
...
CREATE UNIQUE INDEX financial_settings_pkey ON public.financial_settings USING btree (id);
...
CREATE INDEX idx_finance_entries_invoice_referencia ON public.finance_entries USING btree (((invoice_data ->> 'referencia'::text))) WHERE ((invoice_data ->> 'referencia'::text) IS NOT NULL);

CREATE INDEX idx_finance_entries_invoice_status ON public.finance_entries USING btree (invoice_status) WHERE (invoice_status IS NOT NULL);
...
CREATE INDEX idx_payment_gateways_provider ON public.payment_gateways USING btree (provider);

CREATE INDEX idx_payment_gateways_tenant_id ON public.payment_gateways USING btree (tenant_id);

CREATE INDEX idx_payment_gateways_tenant_provider_active ON public.payment_gateways USING btree (tenant_id, provider) WHERE (is_active = true);
...
CREATE UNIQUE INDEX notification_templates_tenant_id_name_key ON public.notification_templates USING btree (tenant_id, name);

CREATE UNIQUE INDEX notifications_pkey ON public.notifications USING btree (id);

CREATE UNIQUE INDEX payment_gateways_pkey ON public.payment_gateways USING btree (id);

CREATE UNIQUE INDEX payment_gateways_tenant_provider_unique ON public.payment_gateways USING btree (tenant_id, provider);

CREATE UNIQUE INDEX product_categories_pkey ON public.product_categories USING btree (id);

CREATE UNIQUE INDEX product_stock_by_location_pkey ON public.product_stock_by_location USING btree (id);

CREATE UNIQUE INDEX product_stock_by_location_unique ON public.product_stock_by_location USING btree (tenant_id, product_id, storage_location_id);
...
CREATE UNIQUE INDEX regua_cobranca_config_pkey ON public.regua_cobranca_config USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_estatisticas_pkey ON public.regua_cobranca_estatisticas USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_etapas_pkey ON public.regua_cobranca_etapas USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_execucao_pkey ON public.regua_cobranca_execucao USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_interacoes_pkey ON public.regua_cobranca_interacoes USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_mensagens_pkey ON public.regua_cobranca_mensagens USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_template_etapas_pkey ON public.regua_cobranca_template_etapas USING btree (id);

CREATE UNIQUE INDEX regua_cobranca_templates_pkey ON public.regua_cobranca_templates USING btree (id);

CREATE UNIQUE INDEX resellers_document_key ON public.resellers USING btree (document);

CREATE UNIQUE INDEX resellers_email_key ON public.resellers USING btree (email);

CREATE UNIQUE INDEX resellers_pkey ON public.resellers USING btree (id);

CREATE UNIQUE INDEX resellers_users_pkey ON public.resellers_users USING btree (id);

CREATE UNIQUE INDEX resellers_users_user_id_reseller_id_key ON public.resellers_users USING btree (user_id, reseller_id);

CREATE UNIQUE INDEX service_billing_events_pkey ON public.service_billing_events USING btree (id);

CREATE UNIQUE INDEX service_order_sequences_pkey ON public.service_order_sequences USING btree (tenant_id);

CREATE UNIQUE INDEX services_pkey ON public.services USING btree (id);

CREATE UNIQUE INDEX services_tenant_id_code_key ON public.services USING btree (tenant_id, code);
...
CREATE UNIQUE INDEX storage_locations_tenant_name_unique ON public.storage_locations USING btree (tenant_id, name);

CREATE UNIQUE INDEX tasks_attachments_pkey ON public.tasks_attachments USING btree (id);

CREATE UNIQUE INDEX tasks_pkey ON public.tasks USING btree (id);

CREATE INDEX tenant_access_codes_code_idx ON public.tenant_access_codes USING btree (code);

CREATE UNIQUE INDEX tenant_access_codes_code_key ON public.tenant_access_codes USING btree (code);

CREATE INDEX tenant_access_codes_expires_at_idx ON public.tenant_access_codes USING btree (expires_at);

CREATE UNIQUE INDEX tenant_access_codes_pkey ON public.tenant_access_codes USING btree (id);
...
CREATE UNIQUE INDEX tenant_integrations_pkey ON public.tenant_integrations USING btree (id);

CREATE UNIQUE INDEX tenant_integrations_tenant_integration_unique ON public.tenant_integrations USING btree (tenant_id, integration_type);
...
CREATE UNIQUE INDEX tenant_invites_token_key ON public.tenant_invites USING btree (token);
...
CREATE UNIQUE INDEX tenant_users_user_tenant_unique ON public.tenant_users USING btree (user_id, tenant_id);

CREATE UNIQUE INDEX tenants_document_key ON public.tenants USING btree (document);

CREATE UNIQUE INDEX tenants_pkey ON public.tenants USING btree (id);

CREATE UNIQUE INDEX tenants_slug_key ON public.tenants USING btree (slug);

CREATE UNIQUE INDEX uk_profiles_name_context ON public.profiles USING btree (name, context);

CREATE UNIQUE INDEX unique_category_name_per_tenant ON public.product_categories USING btree (name, tenant_id);
...
alter table "public"."agente_ia_empresa" add constraint "agente_ia_empresa_pkey" PRIMARY KEY using index "agente_ia_empresa_pkey";

alter table "public"."agente_ia_mensagens_regua" add constraint "agente_ia_mensagens_regua_pkey" PRIMARY KEY using index "agente_ia_mensagens_regua_pkey";

alter table "public"."audit_logs" add constraint "audit_logs_pkey" PRIMARY KEY using index "audit_logs_pkey";

alter table "public"."bank_acounts" add constraint "bank_acounts_pkey" PRIMARY KEY using index "bank_acounts_pkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_pkey" PRIMARY KEY using index "bank_operation_history_pkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_pkey" PRIMARY KEY using index "billing_period_items_pkey";

alter table "public"."charges" add constraint "charges_pkey" PRIMARY KEY using index "charges_pkey";

alter table "public"."conciliation_history" add constraint "conciliation_history_pkey" PRIMARY KEY using index "conciliation_history_pkey";

alter table "public"."conciliation_rules" add constraint "conciliation_rules_pkey" PRIMARY KEY using index "conciliation_rules_pkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_pkey" PRIMARY KEY using index "conciliation_staging_pkey";

alter table "public"."contract_attachments" add constraint "contract_attachments_pkey" PRIMARY KEY using index "contract_attachments_pkey";

alter table "public"."contract_billing_items" add constraint "contract_billing_items_pkey" PRIMARY KEY using index "contract_billing_items_pkey";

alter table "public"."contract_billing_payments" add constraint "contract_billing_payments_pkey" PRIMARY KEY using index "contract_billing_payments_pkey";

alter table "public"."contract_billing_periods" add constraint "contract_billing_periods_pkey" PRIMARY KEY using index "contract_billing_periods_pkey";

alter table "public"."contract_billings" add constraint "contract_billings_pkey" PRIMARY KEY using index "contract_billings_pkey";

alter table "public"."contract_products" add constraint "contract_products_pkey" PRIMARY KEY using index "contract_products_pkey";
...
alter table "public"."contract_stage_history" add constraint "contract_stage_history_pkey" PRIMARY KEY using index "contract_stage_history_pkey";

alter table "public"."contract_stage_transition_rules" add constraint "contract_stage_transition_rules_pkey" PRIMARY KEY using index "contract_stage_transition_rules_pkey";

alter table "public"."contract_stage_transitions" add constraint "contract_stage_transitions_pkey" PRIMARY KEY using index "contract_stage_transitions_pkey";

alter table "public"."contract_stages" add constraint "contract_stages_pkey" PRIMARY KEY using index "contract_stages_pkey";

alter table "public"."contracts" add constraint "contracts_pkey" PRIMARY KEY using index "contracts_pkey";

alter table "public"."customers" add constraint "customers_pkey" PRIMARY KEY using index "customers_pkey";

alter table "public"."des_payables_sequence" add constraint "des_payables_sequence_pkey" PRIMARY KEY using index "des_payables_sequence_pkey";

alter table "public"."finance_entries" add constraint "finance_entries_pkey" PRIMARY KEY using index "finance_entries_pkey";

alter table "public"."financial_documents" add constraint "financial_documents_pkey" PRIMARY KEY using index "financial_documents_pkey";

alter table "public"."financial_launchs" add constraint "financial_launchs_pkey" PRIMARY KEY using index "financial_launchs_pkey";

alter table "public"."financial_payables" add constraint "financial_payables_pkey" PRIMARY KEY using index "financial_payables_pkey";

alter table "public"."financial_settings" add constraint "financial_settings_pkey" PRIMARY KEY using index "financial_settings_pkey";

alter table "public"."health_check" add constraint "health_check_pkey" PRIMARY KEY using index "health_check_pkey";

alter table "public"."message_history" add constraint "message_history_pkey" PRIMARY KEY using index "message_history_pkey";
...
alter table "public"."product_stock_by_location" add constraint "product_stock_by_location_pkey" PRIMARY KEY using index "product_stock_by_location_pkey";
...
alter table "public"."regua_cobranca_config" add constraint "regua_cobranca_config_pkey" PRIMARY KEY using index "regua_cobranca_config_pkey";

alter table "public"."regua_cobranca_estatisticas" add constraint "regua_cobranca_estatisticas_pkey" PRIMARY KEY using index "regua_cobranca_estatisticas_pkey";

alter table "public"."regua_cobranca_etapas" add constraint "regua_cobranca_etapas_pkey" PRIMARY KEY using index "regua_cobranca_etapas_pkey";

alter table "public"."regua_cobranca_execucao" add constraint "regua_cobranca_execucao_pkey" PRIMARY KEY using index "regua_cobranca_execucao_pkey";

alter table "public"."regua_cobranca_interacoes" add constraint "regua_cobranca_interacoes_pkey" PRIMARY KEY using index "regua_cobranca_interacoes_pkey";

alter table "public"."regua_cobranca_mensagens" add constraint "regua_cobranca_mensagens_pkey" PRIMARY KEY using index "regua_cobranca_mensagens_pkey";

alter table "public"."regua_cobranca_template_etapas" add constraint "regua_cobranca_template_etapas_pkey" PRIMARY KEY using index "regua_cobranca_template_etapas_pkey";

alter table "public"."regua_cobranca_templates" add constraint "regua_cobranca_templates_pkey" PRIMARY KEY using index "regua_cobranca_templates_pkey";

alter table "public"."resellers" add constraint "resellers_pkey" PRIMARY KEY using index "resellers_pkey";

alter table "public"."resellers_users" add constraint "resellers_users_pkey" PRIMARY KEY using index "resellers_users_pkey";

alter table "public"."service_billing_events" add constraint "service_billing_events_pkey" PRIMARY KEY using index "service_billing_events_pkey";

alter table "public"."service_order_sequences" add constraint "service_order_sequences_pkey" PRIMARY KEY using index "service_order_sequences_pkey";
...
alter table "public"."tasks_attachments" add constraint "tasks_attachments_pkey" PRIMARY KEY using index "tasks_attachments_pkey";

alter table "public"."tenant_access_codes" add constraint "tenant_access_codes_pkey" PRIMARY KEY using index "tenant_access_codes_pkey";

alter table "public"."tenant_integrations" add constraint "tenant_integrations_pkey" PRIMARY KEY using index "tenant_integrations_pkey";
...
alter table "public"."agente_ia_empresa" add constraint "fk_tenant" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."agente_ia_empresa" validate constraint "fk_tenant";

alter table "public"."agente_ia_mensagens_regua" add constraint "fk_etapa_regua" FOREIGN KEY (etapa_regua_id) REFERENCES public.regua_cobranca_etapas(id) ON DELETE CASCADE not valid;

alter table "public"."agente_ia_mensagens_regua" validate constraint "fk_etapa_regua";

alter table "public"."agente_ia_mensagens_regua" add constraint "fk_tenant" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."agente_ia_mensagens_regua" validate constraint "fk_tenant";

alter table "public"."audit_logs" add constraint "audit_logs_performed_by_fkey" FOREIGN KEY (performed_by) REFERENCES auth.users(id) ON DELETE SET NULL not valid;
...
alter table "public"."bank_acounts" add constraint "bank_acounts_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."bank_acounts" validate constraint "bank_acounts_created_by_fkey";

alter table "public"."bank_acounts" add constraint "bank_acounts_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."bank_acounts" validate constraint "bank_acounts_tenant_id_fkey";

alter table "public"."bank_acounts" add constraint "bank_acounts_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."bank_acounts" validate constraint "bank_acounts_updated_by_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_bank_acount_id_fkey" FOREIGN KEY (bank_acount_id) REFERENCES public.bank_acounts(id) ON DELETE SET NULL not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_bank_acount_id_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_category_fkey" FOREIGN KEY (category) REFERENCES public.financial_settings(id) ON DELETE SET NULL not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_category_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_created_by_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_document_fkey" FOREIGN KEY (document_reference) REFERENCES public.financial_documents(id) ON DELETE SET NULL not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_document_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_tenant_id_fkey";

alter table "public"."bank_operation_history" add constraint "bank_operation_history_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."bank_operation_history" validate constraint "bank_operation_history_updated_by_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_billing_period_id_fkey" FOREIGN KEY (billing_period_id) REFERENCES public.contract_billing_periods(id) not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_billing_period_id_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_product_id_fkey" FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE RESTRICT not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_product_id_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_service_id_fkey" FOREIGN KEY (service_id) REFERENCES public.services(id) ON DELETE RESTRICT not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_service_id_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_stock_movement_id_fkey" FOREIGN KEY (stock_movement_id) REFERENCES public.stock_movements(id) ON DELETE SET NULL not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_stock_movement_id_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_storage_location_id_fkey" FOREIGN KEY (storage_location_id) REFERENCES public.storage_locations(id) ON DELETE SET NULL not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_storage_location_id_fkey";

alter table "public"."billing_period_items" add constraint "billing_period_items_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."billing_period_items" validate constraint "billing_period_items_tenant_id_fkey";

alter table "public"."charges" add constraint "charges_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."charges" validate constraint "charges_created_by_fkey";

alter table "public"."charges" add constraint "charges_customer_id_fkey" FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE CASCADE not valid;

alter table "public"."charges" validate constraint "charges_customer_id_fkey";

alter table "public"."charges" add constraint "charges_tenant_asaas_id_unique" UNIQUE using index "charges_tenant_asaas_id_unique";

alter table "public"."charges" add constraint "charges_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."charges" validate constraint "charges_tenant_id_fkey";

alter table "public"."charges" add constraint "charges_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."charges" validate constraint "charges_updated_by_fkey";

alter table "public"."charges" add constraint "fk_charges_billing_periods" FOREIGN KEY (billing_periods) REFERENCES public.contract_billing_periods(id) ON DELETE SET NULL not valid;

alter table "public"."charges" validate constraint "fk_charges_billing_periods";

alter table "public"."charges" add constraint "fk_charges_contract_id" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE SET NULL not valid;

alter table "public"."charges" validate constraint "fk_charges_contract_id";

alter table "public"."conciliation_history" add constraint "reconciliation_history_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) ON DELETE CASCADE not valid;

alter table "public"."conciliation_history" validate constraint "reconciliation_history_charge_id_fkey";

alter table "public"."conciliation_history" add constraint "reconciliation_history_performed_by_fkey" FOREIGN KEY (performed_by) REFERENCES auth.users(id) not valid;

alter table "public"."conciliation_history" validate constraint "reconciliation_history_performed_by_fkey";

alter table "public"."conciliation_history" add constraint "reconciliation_history_rule_id_fkey" FOREIGN KEY (rule_id) REFERENCES public.conciliation_rules(id) ON DELETE SET NULL not valid;

alter table "public"."conciliation_history" validate constraint "reconciliation_history_rule_id_fkey";

alter table "public"."conciliation_history" add constraint "reconciliation_history_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."conciliation_history" validate constraint "reconciliation_history_tenant_id_fkey";

alter table "public"."conciliation_rules" add constraint "reconciliation_rules_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."conciliation_rules" validate constraint "reconciliation_rules_created_by_fkey";

alter table "public"."conciliation_rules" add constraint "reconciliation_rules_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."conciliation_rules" validate constraint "reconciliation_rules_tenant_id_fkey";

alter table "public"."conciliation_rules" add constraint "reconciliation_rules_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."conciliation_rules" validate constraint "reconciliation_rules_updated_by_fkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) ON DELETE SET NULL not valid;

alter table "public"."conciliation_staging" validate constraint "conciliation_staging_charge_id_fkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_contrato_id_fkey" FOREIGN KEY (contrato_id) REFERENCES public.contracts(id) ON DELETE SET NULL not valid;

alter table "public"."conciliation_staging" validate constraint "conciliation_staging_contrato_id_fkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."conciliation_staging" validate constraint "conciliation_staging_created_by_fkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_id_externo_unique" UNIQUE using index "conciliation_staging_id_externo_unique";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."conciliation_staging" validate constraint "conciliation_staging_tenant_id_fkey";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_tenant_id_origem_id_externo_key" UNIQUE using index "conciliation_staging_tenant_id_origem_id_externo_key";

alter table "public"."conciliation_staging" add constraint "conciliation_staging_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."conciliation_staging" validate constraint "conciliation_staging_updated_by_fkey";

alter table "public"."contract_attachments" add constraint "contract_attachments_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."contract_attachments" validate constraint "contract_attachments_contract_id_fkey";

alter table "public"."contract_attachments" add constraint "contract_attachments_uploaded_by_fkey" FOREIGN KEY (uploaded_by) REFERENCES auth.users(id) not valid;

alter table "public"."contract_attachments" validate constraint "contract_attachments_uploaded_by_fkey";

alter table "public"."contract_attachments" add constraint "fk_contract_attachments_tenant_id" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) not valid;

alter table "public"."contract_attachments" validate constraint "fk_contract_attachments_tenant_id";

alter table "public"."contract_billing_items" add constraint "contract_billing_items_billing_id_fkey" FOREIGN KEY (billing_id) REFERENCES public.contract_billings(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billing_items" validate constraint "contract_billing_items_billing_id_fkey";

alter table "public"."contract_billing_items" add constraint "contract_billing_items_contract_service_id_fkey" FOREIGN KEY (contract_service_id) REFERENCES public.contract_services(id) not valid;

alter table "public"."contract_billing_items" validate constraint "contract_billing_items_contract_service_id_fkey";

alter table "public"."contract_billing_payments" add constraint "contract_billing_payments_billing_id_fkey" FOREIGN KEY (billing_id) REFERENCES public.contract_billings(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billing_payments" validate constraint "contract_billing_payments_billing_id_fkey";

alter table "public"."contract_billing_payments" add constraint "contract_billing_payments_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."contract_billing_payments" validate constraint "contract_billing_payments_created_by_fkey";

alter table "public"."contract_billing_payments" add constraint "contract_billing_payments_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billing_payments" validate constraint "contract_billing_payments_tenant_id_fkey";

alter table "public"."contract_billing_periods" add constraint "contract_billing_periods_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billing_periods" validate constraint "contract_billing_periods_contract_id_fkey";

alter table "public"."contract_billing_periods" add constraint "contract_billing_periods_customer_id_fkey" FOREIGN KEY (customer_id) REFERENCES public.customers(id) not valid;

alter table "public"."contract_billing_periods" validate constraint "contract_billing_periods_customer_id_fkey";

alter table "public"."contract_billing_periods" add constraint "contract_billing_periods_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billing_periods" validate constraint "contract_billing_periods_tenant_id_fkey";

alter table "public"."contract_billings" add constraint "contract_billings_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billings" validate constraint "contract_billings_contract_id_fkey";

alter table "public"."contract_billings" add constraint "contract_billings_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."contract_billings" validate constraint "contract_billings_created_by_fkey";

alter table "public"."contract_billings" add constraint "contract_billings_parent_billing_id_fkey" FOREIGN KEY (parent_billing_id) REFERENCES public.contract_billings(id) ON DELETE SET NULL not valid;

alter table "public"."contract_billings" validate constraint "contract_billings_parent_billing_id_fkey";

alter table "public"."contract_billings" add constraint "contract_billings_tenant_id_billing_number_key" UNIQUE using index "contract_billings_tenant_id_billing_number_key";

alter table "public"."contract_billings" add constraint "contract_billings_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_billings" validate constraint "contract_billings_tenant_id_fkey";

alter table "public"."contract_billings" add constraint "contract_billings_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."contract_billings" validate constraint "contract_billings_updated_by_fkey";

alter table "public"."contract_products" add constraint "contract_products_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."contract_products" validate constraint "contract_products_contract_id_fkey";

alter table "public"."contract_products" add constraint "contract_products_contract_id_product_id_key" UNIQUE using index "contract_products_contract_id_product_id_key";

alter table "public"."contract_products" add constraint "contract_products_product_id_fkey" FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE RESTRICT not valid;

alter table "public"."contract_products" validate constraint "contract_products_product_id_fkey";

alter table "public"."contract_products" add constraint "contract_products_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_products" validate constraint "contract_products_tenant_id_fkey";

alter table "public"."contract_services" add constraint "contract_services_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;
...
alter table "public"."contract_services" add constraint "contract_services_service_id_fkey" FOREIGN KEY (service_id) REFERENCES public.services(id) ON DELETE RESTRICT not valid;

alter table "public"."contract_services" validate constraint "contract_services_service_id_fkey";

alter table "public"."contract_services" add constraint "contract_services_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."contract_services" validate constraint "contract_services_tenant_id_fkey";

alter table "public"."contract_stage_history" add constraint "contract_stage_history_changed_by_fkey" FOREIGN KEY (changed_by) REFERENCES auth.users(id) not valid;

alter table "public"."contract_stage_history" validate constraint "contract_stage_history_changed_by_fkey";

alter table "public"."contract_stage_history" add constraint "contract_stage_history_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_history" validate constraint "contract_stage_history_contract_id_fkey";

alter table "public"."contract_stage_history" add constraint "contract_stage_history_from_stage_id_fkey" FOREIGN KEY (from_stage_id) REFERENCES public.contract_stages(id) ON DELETE SET NULL not valid;

alter table "public"."contract_stage_history" validate constraint "contract_stage_history_from_stage_id_fkey";

alter table "public"."contract_stage_history" add constraint "contract_stage_history_to_stage_id_fkey" FOREIGN KEY (to_stage_id) REFERENCES public.contract_stages(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_history" validate constraint "contract_stage_history_to_stage_id_fkey";

alter table "public"."contract_stage_transition_rules" add constraint "contract_stage_transition_rules_from_stage_id_fkey" FOREIGN KEY (from_stage_id) REFERENCES public.contract_stages(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transition_rules" validate constraint "contract_stage_transition_rules_from_stage_id_fkey";

alter table "public"."contract_stage_transition_rules" add constraint "contract_stage_transition_rules_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transition_rules" validate constraint "contract_stage_transition_rules_tenant_id_fkey";

alter table "public"."contract_stage_transition_rules" add constraint "contract_stage_transition_rules_to_stage_id_fkey" FOREIGN KEY (to_stage_id) REFERENCES public.contract_stages(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transition_rules" validate constraint "contract_stage_transition_rules_to_stage_id_fkey";

alter table "public"."contract_stage_transitions" add constraint "contract_stage_transitions_from_stage_id_fkey" FOREIGN KEY (from_stage_id) REFERENCES public.contract_stages(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transitions" validate constraint "contract_stage_transitions_from_stage_id_fkey";

alter table "public"."contract_stage_transitions" add constraint "contract_stage_transitions_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transitions" validate constraint "contract_stage_transitions_tenant_id_fkey";

alter table "public"."contract_stage_transitions" add constraint "contract_stage_transitions_tenant_id_from_stage_id_to_stage_key" UNIQUE using index "contract_stage_transitions_tenant_id_from_stage_id_to_stage_key";

alter table "public"."contract_stage_transitions" add constraint "contract_stage_transitions_to_stage_id_fkey" FOREIGN KEY (to_stage_id) REFERENCES public.contract_stages(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stage_transitions" validate constraint "contract_stage_transitions_to_stage_id_fkey";

alter table "public"."contract_stages" add constraint "contract_stages_tenant_id_code_key" UNIQUE using index "contract_stages_tenant_id_code_key";

alter table "public"."contract_stages" add constraint "contract_stages_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contract_stages" validate constraint "contract_stages_tenant_id_fkey";
...
alter table "public"."contracts" add constraint "contracts_customer_id_fkey" FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE RESTRICT not valid;

alter table "public"."contracts" validate constraint "contracts_customer_id_fkey";

alter table "public"."contracts" add constraint "contracts_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."contracts" validate constraint "contracts_tenant_id_fkey";

alter table "public"."contracts" add constraint "contracts_tenant_id_number_key" UNIQUE using index "contracts_tenant_id_number_key";

alter table "public"."contracts" add constraint "contracts_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."contracts" validate constraint "contracts_updated_by_fkey";

alter table "public"."contracts" add constraint "fk_contracts_stage_id" FOREIGN KEY (stage_id) REFERENCES public.contract_stages(id) ON DELETE RESTRICT not valid;

alter table "public"."contracts" validate constraint "fk_contracts_stage_id";

alter table "public"."customers" add constraint "customers_asaas_id_cpf_cnpj_key" UNIQUE using index "customers_asaas_id_cpf_cnpj_key";

alter table "public"."customers" add constraint "customers_created_by_fkey" FOREIGN KEY (created_by) REFERENCES public.tenant_users(id) not valid;
...
alter table "public"."finance_entries" add constraint "finance_entries_bank_account_id_fkey" FOREIGN KEY (bank_account_id) REFERENCES public.bank_acounts(id) ON DELETE SET NULL not valid;

alter table "public"."finance_entries" validate constraint "finance_entries_bank_account_id_fkey";

alter table "public"."finance_entries" add constraint "finance_entries_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) not valid;

alter table "public"."finance_entries" validate constraint "finance_entries_charge_id_fkey";

alter table "public"."finance_entries" add constraint "finance_entries_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) not valid;

alter table "public"."finance_entries" validate constraint "finance_entries_contract_id_fkey";

alter table "public"."finance_entries" add constraint "finance_entries_invoice_status_check" CHECK (((invoice_status IS NULL) OR ((invoice_status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'issued'::character varying, 'cancelled'::character varying, 'error'::character varying, 'denied'::character varying])::text[])))) not valid;

alter table "public"."finance_entries" validate constraint "finance_entries_invoice_status_check";

alter table "public"."finance_entries" add constraint "finance_entries_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) not valid;

alter table "public"."finance_entries" validate constraint "finance_entries_tenant_id_fkey";

alter table "public"."financial_documents" add constraint "financial_documents_addition_id_fkey" FOREIGN KEY (addition_id) REFERENCES public.financial_launchs(id) ON DELETE SET NULL not valid;

alter table "public"."financial_documents" validate constraint "financial_documents_addition_id_fkey";

alter table "public"."financial_documents" add constraint "financial_documents_created_by_fkey" FOREIGN KEY (created_by) REFERENCES public.users(id) not valid;

alter table "public"."financial_documents" validate constraint "financial_documents_created_by_fkey";

alter table "public"."financial_documents" add constraint "financial_documents_open_id_fkey" FOREIGN KEY (open_id) REFERENCES public.financial_launchs(id) ON DELETE SET NULL not valid;

alter table "public"."financial_documents" validate constraint "financial_documents_open_id_fkey";

alter table "public"."financial_documents" add constraint "financial_documents_settle_id_fkey" FOREIGN KEY (settle_id) REFERENCES public.financial_launchs(id) ON DELETE SET NULL not valid;

alter table "public"."financial_documents" validate constraint "financial_documents_settle_id_fkey";

alter table "public"."financial_documents" add constraint "financial_documents_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."financial_documents" validate constraint "financial_documents_tenant_id_fkey";

alter table "public"."financial_launchs" add constraint "financial_launchs_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."financial_launchs" validate constraint "financial_launchs_tenant_id_fkey";

alter table "public"."financial_payables" add constraint "financial_payables_bank_account_fk" FOREIGN KEY (bank_account_id) REFERENCES public.bank_acounts(id) ON UPDATE CASCADE ON DELETE SET NULL not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_bank_account_fk";

alter table "public"."financial_payables" add constraint "financial_payables_category_id_fkey" FOREIGN KEY (category_id) REFERENCES public.financial_settings(id) ON DELETE SET NULL not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_category_id_fkey";

alter table "public"."financial_payables" add constraint "financial_payables_created_by_fkey" FOREIGN KEY (created_by) REFERENCES public.users(id) not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_created_by_fkey";

alter table "public"."financial_payables" add constraint "financial_payables_document_id_fkey" FOREIGN KEY (document_id) REFERENCES public.financial_documents(id) ON DELETE SET NULL not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_document_id_fkey";

alter table "public"."financial_payables" add constraint "financial_payables_supplier_id_fkey" FOREIGN KEY (supplier_id) REFERENCES public.customers(id) ON DELETE SET NULL not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_supplier_id_fkey";

alter table "public"."financial_payables" add constraint "financial_payables_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."financial_payables" validate constraint "financial_payables_tenant_id_fkey";

alter table "public"."financial_settings" add constraint "financial_settings_created_by_fkey" FOREIGN KEY (created_by) REFERENCES public.users(id) not valid;

alter table "public"."financial_settings" validate constraint "financial_settings_created_by_fkey";

alter table "public"."financial_settings" add constraint "financial_settings_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."financial_settings" validate constraint "financial_settings_tenant_id_fkey";

alter table "public"."message_history" add constraint "message_history_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) ON DELETE CASCADE not valid;

alter table "public"."message_history" validate constraint "message_history_charge_id_fkey";

alter table "public"."message_history" add constraint "message_history_customer_id_fkey" FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE CASCADE not valid;

alter table "public"."message_history" validate constraint "message_history_customer_id_fkey";

alter table "public"."message_history" add constraint "message_history_template_id_fkey" FOREIGN KEY (template_id) REFERENCES public.notification_templates(id) ON DELETE CASCADE not valid;

alter table "public"."message_history" validate constraint "message_history_template_id_fkey";

alter table "public"."message_history" add constraint "message_history_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."message_history" validate constraint "message_history_tenant_id_fkey";

alter table "public"."notification_templates" add constraint "notification_templates_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."notification_templates" validate constraint "notification_templates_tenant_id_fkey";

alter table "public"."notification_templates" add constraint "notification_templates_tenant_id_name_key" UNIQUE using index "notification_templates_tenant_id_name_key";
...
alter table "public"."payment_gateways" add constraint "payment_gateways_environment_check" CHECK (((environment)::text = ANY ((ARRAY['homologacao'::character varying, 'producao'::character varying, 'sandbox'::character varying, 'production'::character varying])::text[]))) not valid;

alter table "public"."payment_gateways" validate constraint "payment_gateways_environment_check";

alter table "public"."payment_gateways" add constraint "payment_gateways_provider_check" CHECK (((provider)::text = ANY ((ARRAY['asaas'::character varying, 'focusnfe'::character varying, 'nfse_io'::character varying, 'omie'::character varying, 'stripe'::character varying, 'pagarme'::character varying, 'cielo'::character varying])::text[]))) not valid;

alter table "public"."payment_gateways" validate constraint "payment_gateways_provider_check";

alter table "public"."payment_gateways" add constraint "payment_gateways_tenant_provider_unique" UNIQUE using index "payment_gateways_tenant_provider_unique";
...
alter table "public"."product_categories" add constraint "unique_category_name_per_tenant" UNIQUE using index "unique_category_name_per_tenant";

alter table "public"."product_stock_by_location" add constraint "product_stock_by_location_product_id_fkey" FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE not valid;

alter table "public"."product_stock_by_location" validate constraint "product_stock_by_location_product_id_fkey";

alter table "public"."product_stock_by_location" add constraint "product_stock_by_location_storage_location_id_fkey" FOREIGN KEY (storage_location_id) REFERENCES public.storage_locations(id) ON DELETE CASCADE not valid;

alter table "public"."product_stock_by_location" validate constraint "product_stock_by_location_storage_location_id_fkey";

alter table "public"."product_stock_by_location" add constraint "product_stock_by_location_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."product_stock_by_location" validate constraint "product_stock_by_location_tenant_id_fkey";

alter table "public"."product_stock_by_location" add constraint "product_stock_by_location_unique" UNIQUE using index "product_stock_by_location_unique";
...
alter table "public"."profiles" add constraint "uk_profiles_name_context" UNIQUE using index "uk_profiles_name_context";

alter table "public"."receipts" add constraint "receipts_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) ON DELETE CASCADE not valid;

alter table "public"."receipts" validate constraint "receipts_charge_id_fkey";

alter table "public"."receipts" add constraint "receipts_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE SET NULL not valid;

alter table "public"."receipts" validate constraint "receipts_contract_id_fkey";

alter table "public"."receipts" add constraint "receipts_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."receipts" validate constraint "receipts_created_by_fkey";

alter table "public"."receipts" add constraint "receipts_customer_id_fkey" FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE CASCADE not valid;

alter table "public"."receipts" validate constraint "receipts_customer_id_fkey";

alter table "public"."receipts" add constraint "receipts_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."receipts" validate constraint "receipts_tenant_id_fkey";

alter table "public"."receipts" add constraint "receipts_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."receipts" validate constraint "receipts_updated_by_fkey";

alter table "public"."regua_cobranca_config" add constraint "fk_regua_cobranca_config_tenant" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_config" validate constraint "fk_regua_cobranca_config_tenant";

alter table "public"."regua_cobranca_estatisticas" add constraint "regua_cobranca_estatisticas_etapa_id_fkey" FOREIGN KEY (etapa_id) REFERENCES public.regua_cobranca_etapas(id) not valid;

alter table "public"."regua_cobranca_estatisticas" validate constraint "regua_cobranca_estatisticas_etapa_id_fkey";

alter table "public"."regua_cobranca_estatisticas" add constraint "regua_cobranca_estatisticas_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_estatisticas" validate constraint "regua_cobranca_estatisticas_tenant_id_fkey";

alter table "public"."regua_cobranca_etapas" add constraint "regua_cobranca_etapas_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_etapas" validate constraint "regua_cobranca_etapas_tenant_id_fkey";

alter table "public"."regua_cobranca_execucao" add constraint "regua_cobranca_execucao_etapa_id_fkey" FOREIGN KEY (etapa_id) REFERENCES public.regua_cobranca_etapas(id) not valid;

alter table "public"."regua_cobranca_execucao" validate constraint "regua_cobranca_execucao_etapa_id_fkey";

alter table "public"."regua_cobranca_execucao" add constraint "regua_cobranca_execucao_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_execucao" validate constraint "regua_cobranca_execucao_tenant_id_fkey";

alter table "public"."regua_cobranca_interacoes" add constraint "regua_cobranca_interacoes_mensagem_id_fkey" FOREIGN KEY (mensagem_id) REFERENCES public.regua_cobranca_mensagens(id) not valid;

alter table "public"."regua_cobranca_interacoes" validate constraint "regua_cobranca_interacoes_mensagem_id_fkey";

alter table "public"."regua_cobranca_interacoes" add constraint "regua_cobranca_interacoes_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) not valid;

alter table "public"."regua_cobranca_interacoes" validate constraint "regua_cobranca_interacoes_tenant_id_fkey";

alter table "public"."regua_cobranca_mensagens" add constraint "regua_cobranca_mensagens_etapa_id_fkey" FOREIGN KEY (etapa_id) REFERENCES public.regua_cobranca_etapas(id) not valid;

alter table "public"."regua_cobranca_mensagens" validate constraint "regua_cobranca_mensagens_etapa_id_fkey";

alter table "public"."regua_cobranca_mensagens" add constraint "regua_cobranca_mensagens_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) not valid;

alter table "public"."regua_cobranca_mensagens" validate constraint "regua_cobranca_mensagens_tenant_id_fkey";

alter table "public"."regua_cobranca_template_etapas" add constraint "regua_cobranca_template_etapas_template_id_fkey" FOREIGN KEY (template_id) REFERENCES public.regua_cobranca_templates(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_template_etapas" validate constraint "regua_cobranca_template_etapas_template_id_fkey";

alter table "public"."regua_cobranca_templates" add constraint "regua_cobranca_templates_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."regua_cobranca_templates" validate constraint "regua_cobranca_templates_tenant_id_fkey";

alter table "public"."resellers" add constraint "resellers_document_key" UNIQUE using index "resellers_document_key";

alter table "public"."resellers" add constraint "resellers_email_key" UNIQUE using index "resellers_email_key";

alter table "public"."resellers_users" add constraint "resellers_users_public_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE not valid;

alter table "public"."resellers_users" validate constraint "resellers_users_public_user_id_fkey";

alter table "public"."resellers_users" add constraint "resellers_users_reseller_id_fkey" FOREIGN KEY (reseller_id) REFERENCES public.resellers(id) ON DELETE CASCADE not valid;

alter table "public"."resellers_users" validate constraint "resellers_users_reseller_id_fkey";

alter table "public"."resellers_users" add constraint "resellers_users_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."resellers_users" validate constraint "resellers_users_user_id_fkey";

alter table "public"."resellers_users" add constraint "resellers_users_user_id_reseller_id_key" UNIQUE using index "resellers_users_user_id_reseller_id_key";

alter table "public"."service_billing_events" add constraint "service_billing_events_contract_id_fkey" FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE CASCADE not valid;

alter table "public"."service_billing_events" validate constraint "service_billing_events_contract_id_fkey";

alter table "public"."service_billing_events" add constraint "service_billing_events_service_id_fkey" FOREIGN KEY (service_id) REFERENCES public.contract_services(id) ON DELETE CASCADE not valid;

alter table "public"."service_billing_events" validate constraint "service_billing_events_service_id_fkey";

alter table "public"."service_billing_events" add constraint "service_billing_events_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."service_billing_events" validate constraint "service_billing_events_tenant_id_fkey";

alter table "public"."services" add constraint "services_tenant_id_code_key" UNIQUE using index "services_tenant_id_code_key";

alter table "public"."services" add constraint "services_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;
...
alter table "public"."stock_movements" add constraint "stock_movements_destination_storage_location_id_fkey" FOREIGN KEY (destination_storage_location_id) REFERENCES public.storage_locations(id) ON DELETE RESTRICT not valid;

alter table "public"."stock_movements" validate constraint "stock_movements_destination_storage_location_id_fkey";

alter table "public"."stock_movements" add constraint "stock_movements_origin_storage_location_id_fkey" FOREIGN KEY (origin_storage_location_id) REFERENCES public.storage_locations(id) ON DELETE RESTRICT not valid;

alter table "public"."stock_movements" validate constraint "stock_movements_origin_storage_location_id_fkey";
...
alter table "public"."stock_movements" add constraint "stock_movements_storage_location_id_fkey" FOREIGN KEY (storage_location_id) REFERENCES public.storage_locations(id) ON DELETE RESTRICT not valid;

alter table "public"."stock_movements" validate constraint "stock_movements_storage_location_id_fkey";
...
alter table "public"."stock_movements" add constraint "stock_movements_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."stock_movements" validate constraint "stock_movements_updated_by_fkey";

alter table "public"."storage_locations" add constraint "storage_locations_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) ON DELETE SET NULL not valid;

alter table "public"."storage_locations" validate constraint "storage_locations_created_by_fkey";

alter table "public"."storage_locations" add constraint "storage_locations_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."storage_locations" validate constraint "storage_locations_tenant_id_fkey";

alter table "public"."storage_locations" add constraint "storage_locations_tenant_name_unique" UNIQUE using index "storage_locations_tenant_name_unique";

alter table "public"."tasks" add constraint "tasks_assigned_to_fk" FOREIGN KEY (assigned_to) REFERENCES auth.users(id) ON DELETE SET NULL not valid;

alter table "public"."tasks" validate constraint "tasks_assigned_to_fk";

alter table "public"."tasks" add constraint "tasks_charge_id_fkey" FOREIGN KEY (charge_id) REFERENCES public.charges(id) ON DELETE SET NULL not valid;

alter table "public"."tasks" validate constraint "tasks_charge_id_fkey";

alter table "public"."tasks" add constraint "tasks_client_id_fkey" FOREIGN KEY (client_id) REFERENCES public.customers(id) ON DELETE SET NULL not valid;

alter table "public"."tasks" validate constraint "tasks_client_id_fkey";

alter table "public"."tasks" add constraint "tasks_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."tasks" validate constraint "tasks_tenant_id_fkey";

alter table "public"."tasks_attachments" add constraint "tasks_attachments_task_id_fkey" FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON DELETE CASCADE not valid;

alter table "public"."tasks_attachments" validate constraint "tasks_attachments_task_id_fkey";

alter table "public"."tasks_attachments" add constraint "tasks_attachments_uploaded_by_fkey" FOREIGN KEY (uploaded_by) REFERENCES auth.users(id) not valid;

alter table "public"."tasks_attachments" validate constraint "tasks_attachments_uploaded_by_fkey";

alter table "public"."tenant_access_codes" add constraint "tenant_access_codes_code_key" UNIQUE using index "tenant_access_codes_code_key";

alter table "public"."tenant_access_codes" add constraint "tenant_access_codes_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."tenant_access_codes" validate constraint "tenant_access_codes_tenant_id_fkey";

alter table "public"."tenant_access_codes" add constraint "tenant_access_codes_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."tenant_access_codes" validate constraint "tenant_access_codes_user_id_fkey";

alter table "public"."tenant_integrations" add constraint "tenant_integrations_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) not valid;

alter table "public"."tenant_integrations" validate constraint "tenant_integrations_tenant_id_fkey";

alter table "public"."tenant_integrations" add constraint "tenant_integrations_tenant_integration_unique" UNIQUE using index "tenant_integrations_tenant_integration_unique";

alter table "public"."tenant_invites" add constraint "tenant_invites_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."tenant_invites" validate constraint "tenant_invites_tenant_id_fkey";

alter table "public"."tenant_invites" add constraint "tenant_invites_token_key" UNIQUE using index "tenant_invites_token_key";

alter table "public"."tenant_users" add constraint "tenant_users_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."tenant_users" validate constraint "tenant_users_tenant_id_fkey";

alter table "public"."tenant_users" add constraint "tenant_users_tenant_id_user_id_key" UNIQUE using index "tenant_users_tenant_id_user_id_key";

alter table "public"."tenant_users" add constraint "tenant_users_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.users(id) not valid;

alter table "public"."tenant_users" validate constraint "tenant_users_user_id_fkey";

alter table "public"."tenant_users" add constraint "tenant_users_user_tenant_unique" UNIQUE using index "tenant_users_user_tenant_unique";

alter table "public"."tenants" add constraint "tenants_document_key" UNIQUE using index "tenants_document_key";

alter table "public"."tenants" add constraint "tenants_reseller_id_fkey" FOREIGN KEY (reseller_id) REFERENCES public.resellers(id) ON UPDATE CASCADE ON DELETE SET NULL not valid;

alter table "public"."tenants" validate constraint "tenants_reseller_id_fkey";
...
CREATE OR REPLACE FUNCTION public.admin_check_user_exists(user_email text DEFAULT NULL::text, user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.admin_create_user_bypass_rls(user_id uuid, user_email text, user_role_value text DEFAULT 'USER'::text, user_name text DEFAULT NULL::text, user_status text DEFAULT 'ACTIVE'::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.admin_force_create_user(user_id_param uuid, user_email_param text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.admin_get_all_tenants()
 RETURNS TABLE(id uuid, name text, document text, email text, phone text, active boolean, created_at timestamp with time zone, updated_at timestamp with time zone, reseller_id uuid, reseller_name text, slug text)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
AS $function$
...
CREATE OR REPLACE FUNCTION public.admin_get_tenant_pending_invites_v2(tenant_id_param text)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.admin_get_user_sessions(p_user_id uuid, p_updated_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_limit integer DEFAULT 10)
 RETURNS TABLE(id uuid, user_id uuid, created_at timestamp with time zone, updated_at timestamp with time zone, refreshed_at timestamp with time zone, not_after timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION public.admin_list_tenant_ids()
...
CREATE OR REPLACE FUNCTION public.attempt_billing_period_charge(p_period_id uuid, p_tenant_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.attempt_standalone_billing_charge(p_tenant_id uuid, p_period_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.auto_create_tenant_admin()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.auto_generate_billing_forecasts()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION public.auto_generate_billing_periods()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.auto_generate_billing_periods(p_contract_id uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.backfill_billing_periods(p_tenant_id uuid, p_months_ahead integer DEFAULT 12)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.backfill_contract_billing_periods()
 RETURNS TABLE(contract_id uuid, contract_description text, periods_created integer, total_amount numeric)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.backfill_service_order_numbers(p_tenant_id uuid)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.bypass_rls_insert_billing_item(p_billing_id uuid, p_description text, p_quantity numeric, p_unit_price numeric)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.calc_bill_date(p_year integer, p_month integer, p_day integer, p_anticipate_weekends boolean DEFAULT false)
 RETURNS date
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.calc_contract_bill_date(p_contract_id uuid, p_period_start date, p_period_end date)
 RETURNS date
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.calcular_estatisticas_regua(tenant_id uuid, periodo_inicio timestamp without time zone, periodo_fim timestamp without time zone)
 RETURNS TABLE(etapa_id uuid, etapa_nome text, canal character varying, total_enviadas integer, total_abertas integer, total_clicadas integer, total_respondidas integer, total_pagas integer, taxa_abertura numeric, taxa_cliques numeric, taxa_resposta numeric, taxa_conversao numeric)
 LANGUAGE plpgsql
AS $function$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION public.calculate_amount_planned_for_periods(p_contract_id uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.calculate_billing_status()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.calculate_contract_planned_amount(p_contract_id uuid)
 RETURNS numeric
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.calculate_next_bill_date(p_base_date date, p_billing_day integer, p_anticipate_weekends boolean DEFAULT false)
 RETURNS date
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.calculate_risk_score(p_user_id uuid, p_ip_address inet, p_user_agent text, p_event_type text)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.calculate_service_product_due_date(p_contract_id uuid, p_reference_date date DEFAULT CURRENT_DATE)
 RETURNS date
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.calculate_stock_balance(p_tenant_id uuid, p_product_id uuid, p_storage_location_id uuid, p_movement_type public.stock_movement_type, p_quantity numeric, p_unit_value numeric DEFAULT 0)
 RETURNS TABLE(accumulated_balance numeric, unit_cmc numeric, total_cmc numeric)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.call_sync_charges_edge_function()
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.can_transition_stage(p_contract_id uuid, p_to_stage_id uuid, p_user_id uuid DEFAULT auth.uid())
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.cancel_contract_billing(p_billing_id uuid, p_reason text DEFAULT NULL::text, p_user_id uuid DEFAULT auth.uid())
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.cancel_tenant_invite_v2(invite_id_param uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.change_contract_stage(p_contract_id uuid, p_stage_id uuid, p_comments text DEFAULT NULL::text, p_user_id uuid DEFAULT auth.uid())
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.check_active_session()
 RETURNS TABLE(has_session boolean, session_count integer, latest_session_created timestamp with time zone, latest_session_refreshed timestamp with time zone, session_expired boolean)
 LANGUAGE sql
 SECURITY DEFINER
 SET search_path TO 'auth', 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.check_and_fix_login()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.check_overdue_billings()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.check_tenant_access_by_slug(user_id_param uuid, tenant_slug_param text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.check_tenant_access_explicit(p_user_id uuid, p_tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.check_user_permissions(p_user_id uuid, required_role text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.check_user_tenant_access(p_tenant_id uuid, p_user_id uuid DEFAULT auth.uid())
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.check_user_tenant_access_count(p_user_id uuid, p_tenant_id uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.cleanup_old_security_notifications(p_days_to_keep integer DEFAULT 90)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
create or replace view "public"."contract_services_security_documentation" as  SELECT 'contract_services'::text AS table_name,
...
CREATE OR REPLACE FUNCTION public.create_contract_billing_from_charge()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.create_contract_billing_on_charge()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
declare
    template_id uuid;
begin
    -- Template 7 dias antes
    insert into public.notification_templates 
    (tenant_id, name, description, category, message, settings)
    values (
        tenant_id,
        '7 DIAS PARA VENCER',
...
Para sua comodidade, você pode pagar antecipadamente através do link: {cobranca.linkPagamento}
...
Evite juros e multas pagando em dia através do link: {cobranca.linkPagamento}

Conte com a gente! 👍',
        '{"send_days_before": 3, "priority": "high"}'::jsonb
    );

    -- Template 1 dia antes
    insert into public.notification_templates 
    (tenant_id, name, description, category, message, settings)
    values (
        tenant_id,
...
Não deixe para última hora, pague agora mesmo: {cobranca.linkPagamento}

Precisando de ajuda é só nos chamar! 🤝',
        '{"send_days_before": 1, "priority": "urgent"}'::jsonb
    );

    -- Template dia do vencimento
    insert into public.notification_templates 
    (tenant_id, name, description, category, message, settings)
    values (
        tenant_id,
...
Evite a negativação do seu cadastro pagando ainda hoje através do link: {cobranca.linkPagamento}
...
Para regularizar sua situação e evitar maiores transtornos, clique no link: {cobranca.linkPagamento}
...
CREATE OR REPLACE FUNCTION public.create_finance_entry_from_charge()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.create_finance_entry_on_charge_payment()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.create_refresh_token(p_user_id uuid, p_token text, p_device_fingerprint text, p_ip_address inet DEFAULT NULL::inet, p_user_agent text DEFAULT NULL::text, p_tenant_id uuid DEFAULT NULL::uuid, p_expires_hours integer DEFAULT 168)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.create_reseller_invite(p_reseller_id uuid, p_email text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.create_reseller_with_invite(p_name text, p_document text, p_email text, p_phone text, p_commission_rate numeric, p_active boolean DEFAULT true)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.create_service_with_tenant(service_data jsonb)
...
CREATE OR REPLACE FUNCTION public.daily_billing_status_recalc()
 RETURNS TABLE(total_periods_processed integer, total_periods_due_today integer, total_periods_late integer, total_periods_pending integer, total_events_created integer, total_events_updated integer, total_contracts_processed integer)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.deactivate_access_to_inactive_tenants()
 RETURNS TABLE(tenant_id uuid, tenant_name text, affected_users bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.debug_tenant_id(tenant_id_param text)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.debug_user_context()
 RETURNS TABLE(current_user_id uuid, current_tenant_id uuid, is_authenticated boolean, user_role text, tenant_access_count bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.delete_notification(p_notification_id uuid, p_tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.diagnose_contract_services_security()
...
CREATE OR REPLACE FUNCTION public.eligible_services_for_period(p_contract_id uuid, p_period_start date, p_period_end date)
 RETURNS TABLE(service_id uuid, service_name text, service_code text, billing_type text, service_amount numeric, due_date_type text, due_date_value integer, installments integer, no_charge boolean, generate_billing boolean, installment_number integer)
 LANGUAGE plpgsql
AS $function$
DECLARE
    service_rec RECORD;
...
CREATE OR REPLACE FUNCTION public.enforce_active_contract_on_period()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.enforce_assigned_to_tenant()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
/*
...
CREATE OR REPLACE FUNCTION public.exchange_tenant_access_code(p_code character varying, p_user_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.find_or_create_customer_from_staging(p_tenant_id uuid, p_asaas_customer_id text, p_customer_name text, p_customer_email text, p_customer_document text, p_customer_phone text)
 RETURNS uuid
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.fix_billing_inconsistencies()
 RETURNS json
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.generate_billing_number(p_tenant_id uuid)
...
CREATE OR REPLACE FUNCTION public.generate_charge_on_billing()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.generate_contract_billing(p_contract_id uuid, p_tenant_id uuid, p_user_id uuid, p_billing_data jsonb)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.generate_contract_billings(p_contract_id uuid, p_user_id uuid DEFAULT auth.uid())
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.generate_order_number_on_insert_contract_period()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.generate_refresh_token(p_user_id uuid, p_tenant_id uuid)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.generate_tenant_access_code(p_tenant_id uuid, p_expiration_minutes integer DEFAULT 5)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.generate_tenant_access_code(p_tenant_id uuid, p_user_id uuid, p_expiration_minutes integer DEFAULT 5)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.generate_token_hash(token text)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.get_all_resellers()
 RETURNS SETOF public.resellers
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_all_tenants_with_user_count()
 RETURNS TABLE(id uuid, name text, slug text, active boolean, created_at timestamp with time zone, user_count bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_all_user_tenants(p_user_id uuid DEFAULT NULL::uuid)
 RETURNS TABLE(tenant_id uuid, tenant_name text, tenant_slug text, tenant_logo_url text, user_role text)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.get_bank_statement(p_tenant_id uuid, p_bank_acount_id uuid DEFAULT NULL::uuid, p_start date DEFAULT NULL::date, p_end date DEFAULT NULL::date, p_operation_type public.bank_operation_type DEFAULT NULL::public.bank_operation_type)
 RETURNS TABLE(id uuid, bank_acount_id uuid, operation_type public.bank_operation_type, amount numeric, operation_date timestamp with time zone, description text, category text, document_reference text, running_balance numeric)
 LANGUAGE plpgsql
AS $function$
/*
...
CREATE OR REPLACE FUNCTION public.get_billing_period_by_id(p_tenant_id uuid, p_period_id uuid)
 RETURNS SETOF public.contract_billing_periods
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_complementary_billing_config(p_tenant_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_complementary_billing_minimum(p_tenant_id uuid)
 RETURNS numeric
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_current_session_info()
 RETURNS TABLE(session_id uuid, user_id uuid, created_at timestamp with time zone, updated_at timestamp with time zone, factor_id uuid, aal auth.aal_level, not_after timestamp with time zone, refreshed_at timestamp with time zone, user_agent text, ip inet, tag text)
 LANGUAGE sql
 SECURITY DEFINER
 SET search_path TO 'auth', 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_current_tenant_id_simple()
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_decrypted_api_key(p_tenant_id uuid, p_integration_type text DEFAULT 'asaas'::text)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_direct_tenant_access()
 RETURNS TABLE(tenant_id uuid, tenant_name text, tenant_slug text, tenant_logo_url text, user_role text)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_pending_billing_queue_items(p_tenant_id uuid DEFAULT NULL::uuid, p_limit integer DEFAULT 10)
 RETURNS TABLE(id uuid, tenant_id uuid, billing_id uuid, billing_number character varying, amount numeric, due_date date, payment_gateway_id uuid, attempts integer, created_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_products_by_tenant(p_tenant_id uuid, p_search_term text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_is_active boolean DEFAULT NULL::boolean, p_min_price numeric DEFAULT NULL::numeric, p_max_price numeric DEFAULT NULL::numeric, p_in_stock boolean DEFAULT NULL::boolean, p_page integer DEFAULT 1, p_limit integer DEFAULT 50)
 RETURNS TABLE(id uuid, name character varying, description text, code character varying, sku character varying, barcode character varying, category character varying, unit_price numeric, cost_price numeric, stock_quantity integer, min_stock_quantity integer, supplier character varying, is_active boolean, tax_rate numeric, has_inventory boolean, image_url text, tenant_id uuid, created_at timestamp with time zone, updated_at timestamp with time zone, created_by uuid, total_count bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_project_settings()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_reseller_by_id(p_reseller_id uuid)
...
CREATE OR REPLACE FUNCTION public.get_reseller_invites(p_reseller_id uuid)
 RETURNS TABLE(invite_id uuid, email text, status text, created_at timestamp with time zone, token text, reseller_id uuid, reseller_name text)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_reseller_users_with_details(p_reseller_id uuid)
...
CREATE OR REPLACE FUNCTION public.get_security_notification_stats(p_tenant_id uuid DEFAULT NULL::uuid, p_hours integer DEFAULT 24)
 RETURNS TABLE(total_notifications integer, critical_notifications integer, high_notifications integer, medium_notifications integer, low_notifications integer, unacknowledged_notifications integer, most_common_type text, avg_time_to_acknowledge interval)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_security_stats(p_tenant_id uuid DEFAULT NULL::uuid, p_hours integer DEFAULT 24)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.get_server_time_info()
 RETURNS TABLE(server_time timestamp with time zone, server_timezone text, utc_offset interval)
 LANGUAGE sql
 SECURITY DEFINER
AS $function$
  SELECT 
...
CREATE OR REPLACE FUNCTION public.get_services_by_tenant(tenant_uuid uuid)
...
CREATE OR REPLACE FUNCTION public.get_tenant(p_tenant_id uuid DEFAULT NULL::uuid, p_slug text DEFAULT NULL::text, p_user_id uuid DEFAULT auth.uid())
 RETURNS TABLE(id uuid, name text, slug text, active boolean, has_access boolean, role text, branding jsonb, settings jsonb)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_tenant_asaas_credentials(p_tenant_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_tenant_asaas_webhook(p_tenant_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_tenant_contracts(p_tenant_id uuid, p_status character varying DEFAULT NULL::character varying, p_customer_id uuid DEFAULT NULL::uuid, p_stage_id uuid DEFAULT NULL::uuid, p_start_date date DEFAULT NULL::date, p_end_date date DEFAULT NULL::date, p_limit integer DEFAULT 100, p_offset integer DEFAULT 0)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_tenant_id_by_slug(p_slug text, p_user_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.get_tenant_id_by_slug_jwt(target_slug text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.get_tenant_info(p_tenant_id uuid)
 RETURNS TABLE(id uuid, name text, slug text, document text, email text, phone text, active boolean, created_at timestamp with time zone, updated_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_tenant_integrations_by_tenant(tenant_uuid uuid)
 RETURNS TABLE(id integer, tenant_id uuid, integration_type text, is_active boolean, environment character varying, config jsonb, webhook_url text, webhook_token text, last_sync_at timestamp with time zone, sync_status character varying, error_message text, created_at timestamp with time zone, updated_at timestamp with time zone, created_by uuid)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.get_tenant_notifications(p_user_id uuid)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_tenant_pending_invites(tenant_id_param text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_tenant_pending_invites_v2(tenant_id_param text)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_tenant_users_v2(tenant_id_param text)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_notifications(p_tenant_id uuid)
 RETURNS SETOF json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_pending_invites(p_user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_user_pending_invites(user_email_param text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_user_portal_data()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_portal_data(user_id_param uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_role_wrapper()
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_session_stats()
 RETURNS TABLE(total_sessions bigint, active_sessions bigint, expired_sessions bigint, never_refreshed bigint, oldest_session timestamp with time zone, newest_session timestamp with time zone, last_refresh timestamp with time zone)
 LANGUAGE sql
 SECURITY DEFINER
 SET search_path TO 'auth', 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_user_sessions(p_user_id uuid DEFAULT NULL::uuid, p_updated_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_limit integer DEFAULT 10)
 RETURNS TABLE(id uuid, user_id uuid, created_at timestamp with time zone, updated_at timestamp with time zone, refreshed_at timestamp with time zone, not_after timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'auth', 'public'
...
CREATE OR REPLACE FUNCTION public.get_user_tenants(p_user_id uuid)
 RETURNS TABLE(tenant_id uuid, tenant_name text, tenant_slug text, active boolean, role text)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_user_tenants_simple(p_user_id uuid DEFAULT NULL::uuid)
 RETURNS TABLE(tenant_id uuid, tenant_name text, tenant_slug text, tenant_logo_url text, user_role text)
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_users_in_inactive_tenants()
 RETURNS TABLE(user_id uuid, user_email text, tenant_id uuid, tenant_name text, tenant_active boolean, role text)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.get_valid_next_stages(p_contract_id uuid)
 RETURNS TABLE(stage_id uuid, stage_name character varying, stage_code character varying, stage_color character varying, can_auto_transition boolean, transition_conditions jsonb)
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.handle_conciliation_staging_audit()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.handle_contracts_audit()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.identify_charges_needing_sync(p_tenant_id uuid)
 RETURNS TABLE(charge_id uuid, asaas_id text, current_status text, current_data_pagamento date, last_updated timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.import_movements_to_charges(p_tenant_id uuid, p_movement_ids uuid[])
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.initialize_tenant_context_by_slug(p_slug text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.insert_access_log(p_action text, p_resource text, p_tenant_id uuid, p_details jsonb DEFAULT NULL::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.insert_access_log(p_user_id uuid, p_action text, p_resource text, p_tenant_id uuid, p_details jsonb DEFAULT NULL::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.insert_access_log_with_context(p_user_id uuid, p_action text, p_resource text, p_tenant_id uuid, p_details jsonb DEFAULT NULL::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.insert_charge_with_auth_context(p_tenant_id uuid, p_customer_id uuid, p_contract_id uuid, p_valor numeric, p_data_vencimento date, p_status text, p_tipo text, p_descricao text DEFAULT NULL::text, p_user_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.insert_message_history_system(p_charge_id uuid, p_customer_id uuid, p_tenant_id uuid, p_template_id uuid DEFAULT NULL::uuid, p_status text DEFAULT 'SENT'::text, p_message text DEFAULT ''::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.is_complementary_billing_enabled(p_tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.link_existing_charges_to_contracts()
 RETURNS TABLE(charges_updated bigint, charges_skipped bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.lock_pending_import_jobs(batch_size_param integer DEFAULT 5)
 RETURNS TABLE(id uuid, tenant_id uuid, filename text, status text, field_mappings jsonb, created_at timestamp with time zone, updated_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.lock_pending_import_jobs(batch_size_param integer DEFAULT 5, worker_id_param text DEFAULT 'worker-1'::text)
 RETURNS TABLE(id uuid, tenant_id uuid, filename text, status text, field_mappings jsonb, created_at timestamp with time zone, updated_at timestamp with time zone, locked_at timestamp with time zone, locked_by text)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.log_auth_event(p_user_id uuid, p_email text, p_event_type text, p_ip_address inet DEFAULT NULL::inet, p_user_agent text DEFAULT NULL::text, p_details jsonb DEFAULT NULL::jsonb, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.log_contract_stage_change()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.log_financial_payable_payment_to_history()
 ...
 LANGUAGE plpgsql
AS $function$
DECLARE v_amount NUMERIC(18,2); BEGIN
...
CREATE OR REPLACE FUNCTION public.log_resellers_users_changes()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.log_tenant_session_audit(p_session_id uuid, p_user_id uuid, p_tenant_id uuid, p_tenant_slug character varying, p_action character varying, p_ip_address inet DEFAULT NULL::inet, p_user_agent text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.manual_update_last_login(user_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.map_external_status_to_charge_status(status_externo text)
 RETURNS text
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.map_payment_method_to_tipo(payment_method text)
 RETURNS text
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.mark_all_notifications_as_read(p_tenant_id uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.mark_billing_period_as_billed()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.mark_billing_period_as_billed(p_tenant_id uuid, p_period_id uuid, p_manual_reason text DEFAULT NULL::text, p_amount_billed numeric DEFAULT NULL::numeric)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.mark_notification_as_read(p_notification_id uuid, p_tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.mark_period_billed(p_billing_period_id uuid, p_actor uuid, p_reason text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.mark_period_billed(p_contract_id uuid, p_period_start date, p_period_end date, p_charge_id uuid DEFAULT NULL::uuid, p_amount_billed numeric DEFAULT NULL::numeric)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.migrate_conciliation_staging_to_charges()
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.next_des_payable_number(p_tenant_id uuid)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.notify_process_import_jobs()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.notify_process_import_jobs_async()
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.on_charge_created_link_period(p_charge_id uuid, p_contract_id uuid, p_bill_date date, p_amount numeric)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.on_financial_payables_insert_update_bank_balance()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
begin
...
CREATE OR REPLACE FUNCTION public.peek_des_payable_number(p_tenant_id uuid)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.preserve_admin_role()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.prevent_contract_revert_to_draft()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.process_asaas_webhook(p_tenant_id uuid, p_event jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.process_asaas_webhook(tenant_id uuid, event_type text, event_json jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.process_billing_charge_creation()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.process_conciliation_staging_customer_data()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.process_contract_billing_charge()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.process_contract_stage_transitions()
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.recalc_billing_statuses(p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS TABLE(updated_periods integer, pending_to_due integer, due_to_late integer, pending_to_late integer)
 LANGUAGE plpgsql
AS $function$
DECLARE
    v_current_date date := current_date;
...
CREATE OR REPLACE FUNCTION public.recalc_billing_statuses_simple()
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.recalc_contract_period_statuses()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.recalculate_contract_total()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.refresh_financial_payables_status()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
begin
...
CREATE OR REPLACE FUNCTION public.regenerate_contract_billing_forecasts(contract_id_param uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.remove_punctuation(text)
 RETURNS text
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.remove_tenant_user_v2(tenant_id_param text, user_id_param uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.renew_access_token(p_session_id uuid, p_new_access_token text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.repair_user_permissions(user_email text DEFAULT NULL::text, user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
create or replace view "public"."reseller_invites_view" as  SELECT gen_random_uuid() AS invite_id,
    ''::text AS email,
...
CREATE OR REPLACE FUNCTION public.resend_reseller_invite(p_email text, p_reseller_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.resend_tenant_invite_v2(invite_id_param uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.reset_des_payable_sequence(p_tenant_id uuid, p_value bigint DEFAULT 0)
 RETURNS void
 LANGUAGE sql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.reset_monthly_billing()
 RETURNS json
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.revoke_all_tenant_tokens(p_tenant_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.revoke_refresh_tokens(p_user_id uuid, p_device_fingerprint text DEFAULT NULL::text, p_reason text DEFAULT 'USER_LOGOUT'::text)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE OR REPLACE FUNCTION public.revoke_user_tenant_tokens(p_user_id uuid, p_tenant_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.safe_login(user_email text, user_password text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.safe_text_to_uuid(p text)
 RETURNS uuid
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public.safe_upsert_contract_service(p_data jsonb)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.save_webhook_info(p_tenant_id uuid, p_webhook_url text, p_webhook_token text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.search_customers(p_search_term text)
...
CREATE OR REPLACE FUNCTION public.set_auth_context(user_id uuid)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.set_config_wrapper(p_name text, p_value text, p_is_local boolean)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.set_role_from_users_table()
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.set_tenant_config(setting_name text, new_value text, is_local boolean DEFAULT false)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.set_tenant_context_flexible(p_tenant_id uuid, p_user_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.set_tenant_context_flexible_boolean(p_tenant_id uuid, p_user_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.set_tenant_context_simple(p_tenant_id uuid, p_user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.setup_asaas_webhook(p_tenant_id uuid, p_webhook_url text, p_webhook_token text)
...
CREATE OR REPLACE FUNCTION public.skip_billing_period(p_tenant_id uuid, p_period_id uuid, p_skip_reason text DEFAULT NULL::text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.skip_period(p_billing_period_id uuid, p_actor uuid, p_reason text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.smart_upsert_billing_periods_for_contract(p_contract_id uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_billing_periods_relationship()
 RETURNS TABLE(action text, charge_id uuid, billing_period_id uuid, details text)
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.sync_billing_status_on_charge_update()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_charges_from_asaas_all_tenants()
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_charges_from_asaas_for_tenant(p_tenant_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_charges_from_staging_all_tenants()
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_charges_from_staging_for_tenant(p_tenant_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.sync_user_metadata_from_public_users(target_user_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.test_contract_billing_trigger()
 RETURNS json
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.test_jwt_custom_claims_expanded()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.test_tenant_context()
 RETURNS TABLE(current_user_id uuid, current_tenant_id uuid, tenant_access boolean)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.trigger_cleanup_job()
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.trigger_create_billing_periods()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.trigger_import_job_processing()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.trigger_log_session_created()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.trigger_log_session_revoked()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.trigger_log_session_updated()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.trigger_update_billing_periods()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_agente_timestamp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_billing_day_preserve_customizations(p_contract_id uuid, p_new_billing_day integer, p_anticipate_weekends boolean DEFAULT false)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_billing_periods_on_charge_payment()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_billing_periods_status()
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_billing_queue_status(p_queue_id uuid, p_status character varying, p_error_message text DEFAULT NULL::text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.update_charge_from_asaas_data(p_charge_id uuid, p_tenant_id uuid, p_status text, p_data_pagamento date, p_payment_value numeric, p_net_value numeric DEFAULT NULL::numeric, p_interest_rate numeric DEFAULT NULL::numeric, p_fine_rate numeric DEFAULT NULL::numeric, p_discount_value numeric DEFAULT NULL::numeric, p_invoice_url text DEFAULT NULL::text, p_pdf_url text DEFAULT NULL::text, p_transaction_receipt_url text DEFAULT NULL::text, p_external_invoice_number text DEFAULT NULL::text, p_barcode text DEFAULT NULL::text, p_pix_key text DEFAULT NULL::text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_charges_from_staging()
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.update_complementary_billing_config(p_tenant_id uuid, p_config jsonb)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_conciliation_staging_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_contract_billing_periods_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_finance_entries_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public', 'pg_temp'
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_pending_periods_amount(p_contract_id uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_product_stock_by_location_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_sbe_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_security_notifications_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.update_service_event_pendencies(p_tenant_id uuid DEFAULT NULL::uuid, p_contract_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.update_standalone_billing_items_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_stock_movements_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_tenant_integrations_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.update_tenant_user_role_v2(tenant_id_param text, user_id_param uuid, new_role text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.update_user_jwt_tenant(p_tenant_id uuid, p_user_id uuid DEFAULT auth.uid())
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.update_whatsapp_qrcode_history_updated_at()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.upsert_billing_periods_for_contract(p_contract_id uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.upsert_tenant_integration(p_tenant_id uuid, p_integration_type character varying, p_config jsonb, p_is_active boolean DEFAULT true)
 RETURNS TABLE(id integer, tenant_id uuid, integration_type character varying, config jsonb, is_active boolean, created_at timestamp with time zone, updated_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.user_belongs_to_tenant(tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.user_has_contract_service_access(p_contract_id uuid DEFAULT NULL::uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.user_has_contract_service_access_v2(p_contract_id uuid DEFAULT NULL::uuid, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.user_is_tenant_admin(tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
create or replace view "public"."v_complementary_billing_summary" as  SELECT tenant_id,
    contract_id,
    date_trunc('month'::text, (issue_date)::timestamp with time zone) AS billing_month,
    count(*) FILTER (WHERE (billing_type = 'regular'::public.billing_type_enum)) AS regular_billings,
    count(*) FILTER (WHERE (billing_type = 'complementary'::public.billing_type_enum)) AS complementary_billings,
    count(*) FILTER (WHERE (billing_type = 'adjustment'::public.billing_type_enum)) AS adjustment_billings,
    COALESCE(sum(amount) FILTER (WHERE (billing_type = 'regular'::public.billing_type_enum)), (0)::numeric) AS regular_amount,
    COALESCE(sum(amount) FILTER (WHERE (billing_type = 'complementary'::public.billing_type_enum)), (0)::numeric) AS complementary_amount,
    COALESCE(sum(amount) FILTER (WHERE (billing_type = 'adjustment'::public.billing_type_enum)), (0)::numeric) AS adjustment_amount,
    COALESCE(sum(amount), (0)::numeric) AS total_amount
   FROM public.contract_billings cb
  GROUP BY tenant_id, contract_id, (date_trunc('month'::text, (issue_date)::timestamp with time zone));


create or replace view "public"."v_contract_billings_with_complementary" as  SELECT cb.id,
    cb.contract_id,
    cb.tenant_id,
    cb.billing_number,
...
CREATE OR REPLACE FUNCTION public.validate_and_sync_order_sequence(p_tenant_id uuid)
 RETURNS TABLE(tenant_id uuid, sequence_number integer, max_real_number integer, gap integer, synchronized boolean)
 LANGUAGE plpgsql
AS $function$
DECLARE
  v_sequence_number integer;
...
CREATE OR REPLACE FUNCTION public.validate_billing_periods_tenant_single()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION public.validate_jwt_integrity(p_token text DEFAULT NULL::text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.validate_refresh_token(p_refresh_token text, p_tenant_slug text)
 RETURNS TABLE(session_id uuid, user_id uuid, tenant_id uuid, tenant_name text, is_valid boolean, expires_at timestamp with time zone)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.validate_refresh_token(p_token text, p_tenant_id uuid DEFAULT NULL::uuid)
 RETURNS TABLE(user_id uuid, tenant_id uuid, token_id uuid, valid boolean)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
...
CREATE OR REPLACE FUNCTION public.validate_role_exists(role_name text, role_context text DEFAULT NULL::text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.validate_tenant_access_jwt(target_tenant_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'pg_temp'
...
CREATE OR REPLACE FUNCTION public.validate_tenant_token(p_token text, p_tenant_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.verify_and_set_admin_role(user_id uuid)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
create or replace view "public"."vw_contract_services_detailed" as  SELECT cs.id AS contract_service_id,
    cs.contract_id,
    cs.service_id,
    cs.quantity,
    cs.unit_price,
...
grant select on table "public"."users" to "supabase_auth_admin";
  ...
  create policy "agente_ia_empresa_delete"
  on "public"."agente_ia_empresa"
  as permissive
  for delete
  to public
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_ia_empresa_insert"
  on "public"."agente_ia_empresa"
  as permissive
  for insert
  to public
with check (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_ia_empresa_select"
  on "public"."agente_ia_empresa"
  as permissive
  for select
  to public
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_ia_empresa_update"
  on "public"."agente_ia_empresa"
  as permissive
  for update
  to public
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_mensagens_delete"
  on "public"."agente_ia_mensagens_regua"
  as permissive
  for delete
  to public
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_mensagens_insert"
  on "public"."agente_ia_mensagens_regua"
  as permissive
  for insert
  to public
...
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "agente_mensagens_update"
  on "public"."agente_ia_mensagens_regua"
  as permissive
  for update
  to public
...
with check (true);
  ...
  for select
  to public
using ((tenant_id IN ( SELECT t.id
  ...
  create policy "bank_acounts_delete_same_tenant"
  on "public"."bank_acounts"
  as permissive
  for delete
  to public
using (((tenant_id = public.current_tenant_id()) AND public.check_tenant_access_safe(tenant_id)));



  create policy "bank_acounts_insert_same_tenant"
  on "public"."bank_acounts"
  as permissive
  for insert
  to public
with check (((tenant_id = public.current_tenant_id()) AND public.check_tenant_access_safe(tenant_id)));



  create policy "bank_acounts_select_same_tenant"
  on "public"."bank_acounts"
  as permissive
  for select
  to public
using (((tenant_id = public.current_tenant_id()) AND public.check_tenant_access_safe(tenant_id)));
  ...
  create policy "bank_acounts_update_same_tenant"
  on "public"."bank_acounts"
  as permissive
  for update
  to public
...
with check (((tenant_id = public.current_tenant_id()) AND public.check_tenant_access_safe(tenant_id)));
  ...
  create policy "bank_operation_history_delete_policy"
  on "public"."bank_operation_history"
  as permissive
  for delete
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "bank_operation_history_insert_policy"
  on "public"."bank_operation_history"
  as permissive
  for insert
  to public
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "bank_operation_history_select_policy"
  on "public"."bank_operation_history"
  as permissive
  for select
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "bank_operation_history_update_policy"
  on "public"."bank_operation_history"
  as permissive
  for update
  to public
...
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  on "public"."billing_period_items"
  as permissive
  for insert
  to public
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
...
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "charges_unified_delete_policy"
  on "public"."charges"
  as permissive
  for delete
  to authenticated
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
   FROM public.tenant_users tu
  WHERE ((tu.user_id = auth.uid()) AND ((tu.active IS NULL) OR (tu.active = true))))))));



  create policy "charges_unified_insert_policy"
  on "public"."charges"
  as permissive
  for insert
  to authenticated, anon
with check ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
   FROM public.tenant_users tu
  WHERE ((tu.user_id = auth.uid()) AND ((tu.active IS NULL) OR (tu.active = true))))))));



  create policy "charges_unified_select_policy"
  on "public"."charges"
  as permissive
  for select
  to authenticated, anon
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "charges_unified_update_policy"
  on "public"."charges"
  as permissive
  for update
  to authenticated, anon
...
with check ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "Users can insert reconciliation_history for their tenant"
  on "public"."conciliation_history"
  as permissive
  for insert
  to public
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "Users can view reconciliation_history from their tenant"
  on "public"."conciliation_history"
  as permissive
  for select
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "Users can manage reconciliation_rules for their tenant"
  on "public"."conciliation_rules"
  as permissive
  for all
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "Users can view reconciliation_rules from their tenant"
  on "public"."conciliation_rules"
  as permissive
  for select
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "conciliation_staging_tenant_context_isolation"
  on "public"."conciliation_staging"
  as permissive
  for all
  to public
using (((tenant_id = public.get_tenant_id()) OR (public.get_tenant_id() IS NULL)));
  ...
  create policy "service_role_full_access_conciliation_staging"
  on "public"."conciliation_staging"
  as permissive
  for all
  to service_role
...
with check (true);
  ...
  create policy "contract_attachments_tenant_access"
...
with check (public.user_has_tenant_access(tenant_id));
  ...
  create policy "Acesso a itens de faturamento baseado em acesso ao faturamento"
  on "public"."contract_billing_items"
  as permissive
  for all
  to public
using ((billing_id IN ( SELECT contract_billings.id
   FROM public.contract_billings
  ...
  create policy "Acesso a pagamentos baseado em tenant"
  on "public"."contract_billing_payments"
  as permissive
  for all
  to public
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  on "public"."contract_billing_periods"
  as permissive
  for all
  to public
using ((((current_setting('app.current_tenant_id'::text, true) IS NOT NULL) AND (tenant_id = (current_setting('app.current_tenant_id'::text, true))::uuid)) OR ((current_setting('app.tenant_id'::text, true) IS NOT NULL) AND (tenant_id = (current_setting('app.tenant_id'::text, true))::uuid)) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "contract_billings_delete_policy"
  on "public"."contract_billings"
  as permissive
  for delete
  to authenticated
using (((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "contract_billings_insert_policy"
  on "public"."contract_billings"
  as permissive
  for insert
  to authenticated
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "contract_billings_select_policy"
  on "public"."contract_billings"
  as permissive
  for select
  to authenticated
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "contract_billings_update_policy"
  on "public"."contract_billings"
  as permissive
  for update
  to authenticated
...
with check ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  create policy "contract_services_unified_delete_policy"
...
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "contract_services_unified_insert_policy"
  on "public"."contract_services"
  as permissive
  for insert
  to authenticated
with check ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "contract_services_unified_select_policy"
  on "public"."contract_services"
  as permissive
  for select
  to public
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "contract_services_unified_update_policy"
  on "public"."contract_services"
  as permissive
  for update
  to public
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
   FROM public.tenant_users tu
  WHERE ((tu.user_id = auth.uid()) AND ((tu.active IS NULL) OR (tu.active = true))))))))
with check (((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
   FROM public.tenant_users tu
  WHERE ((tu.user_id = auth.uid()) AND ((tu.active IS NULL) OR (tu.active = true)))))));



  create policy "Acesso a histórico baseado em acesso ao contrato"
  on "public"."contract_stage_history"
  as permissive
  for all
  to public
using ((contract_id IN ( SELECT contracts.id
  ...
  create policy "Allow contract_stage_history operations for development"
  on "public"."contract_stage_history"
  as permissive
  for all
  to public
...
with check (true);
  ...
  create policy "simple_contract_stage_transitions_access"
  on "public"."contract_stage_transitions"
  as permissive
  for all
  to public
using (public.check_user_tenant_access(tenant_id))
with check (public.check_user_tenant_access(tenant_id));



  create policy "Allow contract_stages operations for development"
...
with check (true);
  ...
  create policy "simple_contract_stages_access"
  on "public"."contract_stages"
  as permissive
  for all
  to public
...
with check (((EXISTS ( SELECT 1
  ...
  create policy "contracts_tenant_secure"
  on "public"."contracts"
  as permissive
  for all
  to public
using ((tenant_id = COALESCE((current_setting('app.tenant_id'::text, true))::uuid, tenant_id)))
with check ((tenant_id = COALESCE((current_setting('app.tenant_id'::text, true))::uuid, tenant_id)));



  create policy "customers_tenant_secure"
  on "public"."customers"
  as permissive
  for all
  to public
...
with check ((tenant_id = COALESCE((current_setting('app.tenant_id'::text, true))::uuid, tenant_id)));
  ...
  create policy "Users can delete finance entries from their tenant"
  on "public"."finance_entries"
  as permissive
  for delete
  to public
using (((tenant_id = public.get_tenant_id()) OR (auth.role() = 'service_role'::text)));



  create policy "Users can insert finance entries for their tenant"
  on "public"."finance_entries"
  as permissive
  for insert
  to public
with check (((tenant_id = public.get_tenant_id()) OR (auth.role() = 'service_role'::text)));



  create policy "Users can update finance entries from their tenant"
  on "public"."finance_entries"
  as permissive
  for update
  to public
...
with check (((tenant_id = public.get_tenant_id()) OR (auth.role() = 'service_role'::text)));
  ...
  create policy "Users can view finance entries from their tenant"
  on "public"."finance_entries"
  as permissive
  for select
  to public
...
with check ((tenant_id = (current_setting('app.tenant_id'::text, true))::uuid));
  ...
  create policy "fl_tenant_delete"
  on "public"."financial_launchs"
  as permissive
  for delete
  to public
using (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
   FROM public.tenant_users
  WHERE ((tenant_users.tenant_id = financial_launchs.tenant_id) AND (tenant_users.active = true))))));



  create policy "fl_tenant_insert"
  on "public"."financial_launchs"
  as permissive
  for insert
  to public
with check (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
   FROM public.tenant_users
  WHERE ((tenant_users.tenant_id = financial_launchs.tenant_id) AND (tenant_users.active = true))))));



  create policy "fl_tenant_select"
  on "public"."financial_launchs"
  as permissive
  for select
  to public
using (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
  ...
  create policy "fl_tenant_update"
  on "public"."financial_launchs"
  as permissive
  for update
  to public
...
with check ((tenant_id = (current_setting('app.tenant_id'::text, true))::uuid));
  ...
  create policy "tenant_isolation_financial_settings_delete"
...
using (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
  ...
  create policy "tenant_isolation_financial_settings_insert"
  on "public"."financial_settings"
  as permissive
  for insert
  to public
with check (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
  ...
  create policy "tenant_isolation_financial_settings_select"
  on "public"."financial_settings"
  as permissive
  for select
  to public
using (((tenant_id = public.current_tenant_id()) OR (auth.uid() IN ( SELECT tenant_users.user_id
  ...
  create policy "tenant_isolation_financial_settings_update"
  on "public"."financial_settings"
  as permissive
  for update
  to public
...
using (true);
  ...
  create policy "strict_tenant_isolation_policy"
...
using ((EXISTS ( SELECT 1
  ...
  create policy "tenant_strict_isolation_policy"
  on "public"."notifications"
  as permissive
  for all
  to public
using (((tenant_id = COALESCE((current_setting('app.current_tenant_id'::text, true))::uuid, ( SELECT tenant_users.tenant_id
   FROM public.tenant_users
  WHERE (tenant_users.user_id = auth.uid())
...
with check (((tenant_id = COALESCE((current_setting('app.current_tenant_id'::text, true))::uuid, ( SELECT tenant_users.tenant_id
   FROM public.tenant_users
  WHERE (tenant_users.user_id = auth.uid())
 LIMIT 1))) AND (EXISTS ( SELECT 1
   FROM public.tenant_users
...
using ((tenant_id IN ( SELECT tenant_users.tenant_id
   FROM public.tenant_users
  WHERE ((tenant_users.user_id = auth.uid()) AND (tenant_users.role = ANY (ARRAY['TENANT_ADMIN'::text, 'TENANT_OWNER'::text]))))));
...
using ((tenant_id IN ( SELECT tenant_users.tenant_id
  ...
  for select
  to authenticated
using ((((context = 'TENANT'::text) AND (EXISTS ( SELECT 1
   FROM public.tenant_users tu
...
using ((tenant_id = (current_setting('app.current_tenant_id'::text))::uuid));
  ...
  create policy "Admins do tenant podem gerenciar configurações da régua"
  on "public"."regua_cobranca_config"
  as permissive
  for all
  to public
using ((EXISTS ( SELECT 1
  ...
  create policy "Usuários do tenant podem ver configurações da régua"
  on "public"."regua_cobranca_config"
  as permissive
  for select
  to public
using ((EXISTS ( SELECT 1
  ...
  create policy "Admins do tenant podem gerenciar etapas da régua"
  on "public"."regua_cobranca_etapas"
  as permissive
  for all
  to public
using (public.user_is_tenant_admin(tenant_id));
  ...
  create policy "Usuários do tenant podem ver etapas da régua"
  on "public"."regua_cobranca_etapas"
  as permissive
  for select
  to public
using (public.user_belongs_to_tenant(tenant_id));
  ...
  create policy "Permitir acesso a revendedores para usuários autenticados"
  on "public"."resellers"
  as permissive
  for all
  to authenticated
...
with check (true);
  ...
  create policy "Reseller admins can manage users"
  on "public"."resellers_users"
  as permissive
  for all
  to public
using (((auth.uid() IN ( SELECT resellers_users.user_id
   FROM public.users
...
using ((auth.uid() = user_id));
  ...
  create policy "policy_sbe_tenant_isolation"
  on "public"."service_billing_events"
  as permissive
  for all
  to authenticated
...
with check ((tenant_id = (current_setting('app.current_tenant_id'::text, true))::uuid));
  ...
  create policy "services_unified_delete_policy"
  on "public"."services"
  as permissive
  for delete
  to public
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "services_unified_insert_policy"
  on "public"."services"
  as permissive
  for insert
  to public
with check ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "services_unified_select_policy"
  on "public"."services"
  as permissive
  for select
  to public
using ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "services_unified_update_policy"
  on "public"."services"
  as permissive
  for update
  to public
...
with check ((((public.get_current_tenant_context_robust() IS NOT NULL) AND (tenant_id = public.get_current_tenant_context_robust())) OR ((auth.uid() IS NOT NULL) AND (tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "Secure tenant access to tasks"
  on "public"."tasks"
  as permissive
  for all
  to public
...
with check ((tenant_id IN ( SELECT tu.tenant_id
  ...
  create policy "Tenant context access to tasks"
  on "public"."tasks"
  as permissive
  for all
  to postgres
...
with check (((tenant_id)::text = current_setting('app.current_tenant_id'::text, true)));
  ...
  on "public"."tasks_attachments"
  as permissive
  for delete
  to public
using (((COALESCE(current_setting('app.tenant_id'::text, true), ''::text) <> ''::text) AND (tenant_id = (current_setting('app.tenant_id'::text, true))::uuid)));
  ...
  for insert
  to public
with check (((COALESCE(current_setting('app.tenant_id'::text, true), ''::text) <> ''::text) AND (tenant_id = (current_setting('app.tenant_id'::text, true))::uuid)));
...
using (((COALESCE(current_setting('app.tenant_id'::text, true), ''::text) <> ''::text) AND (tenant_id = (current_setting('app.tenant_id'::text, true))::uuid)));
  ...
  create policy "admin_select_tenant_access_codes"
  on "public"."tenant_access_codes"
  as permissive
  for select
  to public
using ((auth.uid() IN ( SELECT tenant_users.user_id
   FROM public.tenant_users
...
using (false);
  ...
  create policy "tenant_access_codes_delete_policy"
  on "public"."tenant_access_codes"
  as permissive
  for delete
  to public
using ((EXISTS ( SELECT 1
  ...
  create policy "tenant_access_codes_insert_policy"
  on "public"."tenant_access_codes"
  as permissive
  for insert
  to public
with check ((auth.uid() = user_id));
  ...
  create policy "tenant_access_codes_select_policy"
  on "public"."tenant_access_codes"
  as permissive
  for select
  to public
using (((auth.uid() = user_id) OR (EXISTS ( SELECT 1
  ...
  create policy "tenant_access_codes_update_policy"
  on "public"."tenant_access_codes"
  as permissive
  for update
  to public
using ((auth.uid() = user_id));
  ...
  create policy "tenant_integrations_delete_policy_v2"
  on "public"."tenant_integrations"
  as permissive
  for delete
  to public
using (((tenant_id = public.get_current_tenant_id()) OR (auth.role() = 'service_role'::text)));



  create policy "tenant_integrations_insert_policy_v2"
  on "public"."tenant_integrations"
  as permissive
  for insert
  to public
with check (((tenant_id = public.get_current_tenant_id()) OR (auth.role() = 'service_role'::text)));



  create policy "tenant_integrations_select_policy_v2"
  on "public"."tenant_integrations"
  as permissive
  for select
  to public
using (((tenant_id = public.get_current_tenant_id()) OR (auth.role() = 'service_role'::text)));
  ...
  create policy "tenant_integrations_update_policy_v2"
  on "public"."tenant_integrations"
  as permissive
  for update
  to public
...
with check (((tenant_id = public.get_current_tenant_id()) OR (auth.role() = 'service_role'::text)));
  ...
  create policy "Admins do tenant podem gerenciar convites"
...
using ((email = (( SELECT users.email
  ...
  create policy "Usuários do tenant podem ver convites"
  on "public"."tenant_invites"
  as permissive
  for select
  to public
...
using (((status = 'PENDING'::text) AND (expires_at > now())));
  ...
  create policy "simple_tenant_invites_policy"
  on "public"."tenant_invites"
  as permissive
  for all
  to public
...
with check (true);
  ...
  create policy "tenant_admin_invites_policy"
  on "public"."tenant_invites"
  as permissive
  for all
  to authenticated
using ((EXISTS ( SELECT 1
  ...
  create policy "user_invites_policy"
  on "public"."tenant_invites"
  as permissive
  for select
  to authenticated
using (((email = (( SELECT users.email
  ...
  create policy "Allow auth admin to read tenant_users"
...
using (((user_id = auth.uid()) OR (EXISTS ( SELECT 1
  ...
  create policy "simple_tenant_users_access"
  on "public"."tenant_users"
  as permissive
  for all
  to public
...
with check (((EXISTS ( SELECT 1
  ...
  create policy "simple_tenant_users_policy"
  on "public"."tenant_users"
  as permissive
  for all
  to public
...
with check (true);
  ...
  create policy "supabase_auth_admin_tenant_users_select"
  on "public"."tenant_users"
  as permissive
  for select
  to supabase_auth_admin
using (true);
  ...
  create policy "user_tenant_users_policy"
  on "public"."tenant_users"
  as permissive
  for select
  to authenticated
...
with check (true);
  ...
  create policy "Allow users to select tenants they belong to"
  on "public"."tenants"
  as permissive
  for select
  to authenticated
using ((EXISTS ( SELECT 1
  ...
  create policy "supabase_auth_admin_tenants_select"
  on "public"."tenants"
  as permissive
  for select
  to supabase_auth_admin
...
using (true);
  ...
  create policy "enable_all_authenticated_users"
  on "public"."users"
  as permissive
  for all
  to public
...
CREATE TRIGGER set_agente_timestamp BEFORE UPDATE ON public.agente_ia_empresa FOR EACH ROW EXECUTE FUNCTION public.update_agente_timestamp();

CREATE TRIGGER set_agente_mensagens_timestamp BEFORE UPDATE ON public.agente_ia_mensagens_regua FOR EACH ROW EXECUTE FUNCTION public.update_agente_timestamp();

CREATE TRIGGER bank_history_adjust_on_delete AFTER DELETE ON public.bank_operation_history FOR EACH ROW EXECUTE FUNCTION public.adjust_balance_on_history_delete();

CREATE TRIGGER bank_history_adjust_on_insert AFTER INSERT ON public.bank_operation_history FOR EACH ROW EXECUTE FUNCTION public.adjust_balance_on_history_insert();

CREATE TRIGGER bank_history_adjust_on_update AFTER UPDATE ON public.bank_operation_history FOR EACH ROW EXECUTE FUNCTION public.adjust_balance_on_history_update();

CREATE TRIGGER bank_operation_history_updated_at BEFORE UPDATE ON public.bank_operation_history FOR EACH ROW EXECUTE FUNCTION public.update_bank_operation_history_updated_at();

CREATE TRIGGER trigger_update_standalone_billing_items_updated_at BEFORE UPDATE ON public.billing_period_items FOR EACH ROW EXECUTE FUNCTION public.update_standalone_billing_items_updated_at();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.charges FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER trigger_create_finance_entry_from_charge AFTER UPDATE ON public.charges FOR EACH ROW EXECUTE FUNCTION public.create_finance_entry_from_charge();

CREATE TRIGGER trigger_create_finance_entry_on_charge_payment AFTER UPDATE ON public.charges FOR EACH ROW EXECUTE FUNCTION public.create_finance_entry_on_charge_payment();

CREATE TRIGGER trigger_mark_billing_period_as_billed AFTER INSERT ON public.charges FOR EACH ROW EXECUTE FUNCTION public.mark_billing_period_as_billed();

CREATE TRIGGER trigger_sync_billing_status_on_charge_update AFTER UPDATE ON public.charges FOR EACH ROW WHEN (((new.contract_id IS NOT NULL) AND (old.status IS DISTINCT FROM new.status))) EXECUTE FUNCTION public.sync_billing_status_on_charge_update();

CREATE TRIGGER trigger_update_billing_periods_on_charge_payment AFTER UPDATE ON public.charges FOR EACH ROW EXECUTE FUNCTION public.update_billing_periods_on_charge_payment();

CREATE TRIGGER trigger_validate_billing_periods_tenant_single BEFORE INSERT OR UPDATE ON public.charges FOR EACH ROW EXECUTE FUNCTION public.validate_billing_periods_tenant_single();

CREATE TRIGGER trigger_conciliation_staging_audit BEFORE INSERT OR UPDATE ON public.conciliation_staging FOR EACH ROW EXECUTE FUNCTION public.handle_conciliation_staging_audit();

CREATE TRIGGER trigger_conciliation_staging_customer_data BEFORE INSERT OR UPDATE OF asaas_customer_id ON public.conciliation_staging FOR EACH ROW WHEN (((new.asaas_customer_id IS NOT NULL) AND (new.asaas_customer_id <> ''::text))) EXECUTE FUNCTION public.process_conciliation_staging_customer_data();

CREATE TRIGGER trigger_update_conciliation_staging_updated_at BEFORE UPDATE ON public.conciliation_staging FOR EACH ROW EXECUTE FUNCTION public.update_conciliation_staging_updated_at();

CREATE TRIGGER update_billing_status_after_payment AFTER INSERT ON public.contract_billing_payments FOR EACH ROW EXECUTE FUNCTION public.calculate_billing_status();

CREATE TRIGGER trg_enforce_active_contract_on_period BEFORE INSERT ON public.contract_billing_periods FOR EACH ROW EXECUTE FUNCTION public.enforce_active_contract_on_period();

CREATE TRIGGER trigger_auto_update_billing_status AFTER INSERT OR UPDATE ON public.contract_billing_periods FOR EACH ROW EXECUTE FUNCTION public.auto_update_billing_status();

CREATE TRIGGER trigger_cbp_updated_at BEFORE UPDATE ON public.contract_billing_periods FOR EACH ROW EXECUTE FUNCTION public.update_contract_billing_periods_updated_at();

CREATE TRIGGER trigger_generate_order_number_contract_period BEFORE INSERT ON public.contract_billing_periods FOR EACH ROW WHEN ((new.order_number IS NULL)) EXECUTE FUNCTION public.generate_order_number_on_insert_contract_period();

CREATE TRIGGER trg_after_insert_contract_billings AFTER INSERT ON public.contract_billings FOR EACH ROW EXECUTE FUNCTION public.process_contract_billing_charge();
ALTER TABLE "public"."contract_billings" DISABLE TRIGGER "trg_after_insert_contract_billings";

CREATE TRIGGER update_contract_totals_products AFTER INSERT OR DELETE OR UPDATE ON public.contract_products FOR EACH ROW EXECUTE FUNCTION public.recalculate_contract_total();

CREATE TRIGGER update_contract_totals AFTER INSERT OR DELETE OR UPDATE ON public.contract_services FOR EACH ROW EXECUTE FUNCTION public.recalculate_contract_total();

CREATE TRIGGER log_contract_stage_changes AFTER UPDATE ON public.contracts FOR EACH ROW WHEN ((old.stage_id IS DISTINCT FROM new.stage_id)) EXECUTE FUNCTION public.log_contract_stage_change();

CREATE TRIGGER trg_prevent_contract_revert_to_draft BEFORE UPDATE ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.prevent_contract_revert_to_draft();

CREATE TRIGGER trigger_auto_generate_billing_forecasts AFTER INSERT ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.auto_generate_billing_forecasts();

CREATE TRIGGER trigger_contracts_audit_insert BEFORE INSERT ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.handle_contracts_audit();

CREATE TRIGGER trigger_contracts_audit_update BEFORE UPDATE ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.handle_contracts_audit();

CREATE TRIGGER trigger_contracts_insert_billing_periods AFTER INSERT ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.trigger_create_billing_periods();

CREATE TRIGGER trigger_contracts_update_billing_periods AFTER UPDATE ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.trigger_update_billing_periods();

CREATE TRIGGER trigger_generate_charge_on_billing AFTER UPDATE ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.generate_charge_on_billing();

CREATE TRIGGER update_contracts_updated_at BEFORE UPDATE ON public.contracts FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.customers FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER trigger_update_finance_entries_updated_at BEFORE UPDATE ON public.finance_entries FOR EACH ROW EXECUTE FUNCTION public.update_finance_entries_updated_at();

CREATE TRIGGER trg_financial_documents_updated_at BEFORE UPDATE ON public.financial_documents FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();

CREATE TRIGGER trg_financial_launchs_updated_at BEFORE UPDATE ON public.financial_launchs FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();

CREATE TRIGGER financial_payables_insert_to_history AFTER INSERT ON public.financial_payables FOR EACH ROW EXECUTE FUNCTION public.log_financial_payable_insert_to_history();

CREATE TRIGGER financial_payables_payment_to_history AFTER UPDATE ON public.financial_payables FOR EACH ROW EXECUTE FUNCTION public.log_financial_payable_payment_to_history();

CREATE TRIGGER trg_financial_payables_status BEFORE INSERT OR UPDATE OF due_date, payment_date, paid_amount, status ON public.financial_payables FOR EACH ROW EXECUTE FUNCTION public.set_financial_payable_status();

CREATE TRIGGER trg_financial_payables_updated_at BEFORE UPDATE ON public.financial_payables FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();

CREATE TRIGGER trg_financial_settings_updated_at BEFORE UPDATE ON public.financial_settings FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.message_history FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.notification_templates FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER payment_gateways_updated_at_trigger BEFORE UPDATE ON public.payment_gateways FOR EACH ROW EXECUTE FUNCTION public.update_payment_gateways_updated_at();
...
CREATE TRIGGER product_stock_by_location_updated_at BEFORE UPDATE ON public.product_stock_by_location FOR EACH ROW EXECUTE FUNCTION public.update_product_stock_by_location_updated_at();

CREATE TRIGGER update_products_updated_at BEFORE UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER trigger_receipts_updated_at BEFORE UPDATE ON public.receipts FOR EACH ROW EXECUTE FUNCTION public.update_receipts_updated_at();

CREATE TRIGGER set_timestamp_regua_config BEFORE UPDATE ON public.regua_cobranca_config FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();

CREATE TRIGGER set_timestamp_regua_etapas BEFORE UPDATE ON public.regua_cobranca_etapas FOR EACH ROW EXECUTE FUNCTION public.trigger_set_timestamp();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.resellers FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
...
CREATE TRIGGER track_resellers_users_changes AFTER INSERT OR DELETE OR UPDATE ON public.resellers_users FOR EACH ROW EXECUTE FUNCTION public.log_resellers_users_changes();

CREATE TRIGGER trigger_resellers_users_validate_role BEFORE INSERT OR UPDATE ON public.resellers_users FOR EACH ROW EXECUTE FUNCTION public.trigger_validate_role();

CREATE TRIGGER trigger_sbe_updated_at BEFORE UPDATE ON public.service_billing_events FOR EACH ROW EXECUTE FUNCTION public.update_sbe_updated_at();

CREATE TRIGGER update_services_updated_at BEFORE UPDATE ON public.services FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER stock_movements_updated_at BEFORE UPDATE ON public.stock_movements FOR EACH ROW EXECUTE FUNCTION public.update_stock_movements_updated_at();

CREATE TRIGGER trigger_update_storage_locations_updated_at BEFORE UPDATE ON public.storage_locations FOR EACH ROW EXECUTE FUNCTION public.update_storage_locations_updated_at();

CREATE TRIGGER trg_tasks_assigned_to_tenant BEFORE INSERT OR UPDATE OF assigned_to, tenant_id ON public.tasks FOR EACH ROW EXECUTE FUNCTION public.enforce_assigned_to_tenant();
...
CREATE TRIGGER generate_invite_token_trigger BEFORE INSERT ON public.tenant_invites FOR EACH ROW EXECUTE FUNCTION public.generate_invite_token();

CREATE TRIGGER process_accepted_invite_trigger AFTER UPDATE ON public.tenant_invites FOR EACH ROW WHEN (((new.status = 'ACCEPTED'::text) AND (old.status = 'PENDING'::text))) EXECUTE FUNCTION public.process_accepted_invite();

CREATE TRIGGER trigger_tenant_invites_validate_role BEFORE INSERT OR UPDATE ON public.tenant_invites FOR EACH ROW EXECUTE FUNCTION public.trigger_validate_role();

CREATE TRIGGER trigger_tenant_users_validate_role BEFORE INSERT OR UPDATE ON public.tenant_users FOR EACH ROW EXECUTE FUNCTION public.trigger_validate_role();

CREATE TRIGGER update_tenant_users_updated_at_trigger BEFORE UPDATE ON public.tenant_users FOR EACH ROW EXECUTE FUNCTION public.update_tenant_users_updated_at();

CREATE TRIGGER auto_create_tenant_admin_trigger AFTER INSERT ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.auto_create_tenant_admin();
ALTER TABLE "public"."tenants" DISABLE TRIGGER "auto_create_tenant_admin_trigger";

CREATE TRIGGER create_tenant_templates AFTER INSERT ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.handle_new_tenant();

CREATE TRIGGER set_timestamp BEFORE UPDATE ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER trigger_set_tenant_slug BEFORE INSERT ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.set_tenant_slug();

CREATE TRIGGER normalize_user_role_trigger BEFORE INSERT OR UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.normalize_user_role();

CREATE TRIGGER preserve_admin_role_trigger BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.preserve_admin_role();

CREATE TRIGGER prevent_role_self_promotion BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.protect_user_role_changes();

CREATE TRIGGER sync_roles_on_update BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.sync_user_roles();

CREATE TRIGGER trigger_update_users_timestamp BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.update_users_updated_at();
